...
void acczee_deta(TString input="root://eoscms.cern.ch//store/user/jlawhorn/PYTHIA-CT10nlo-RW/zee-bacon.root",
		 TString outputDir="/afs/cern.ch/work/j/jlawhorn/public/wz-envelopes/",
		 TString pdfName="CT10nlo_as_0117",
		 Int_t iPdfSet=0) {

  TString output=outputDir+"zee_"+pdfName+".root";
  ...
  for (Int_t i=0; i<chain.GetEntries(); i++) {
    ...
    dEta->Fill(zee.Eta(),weight);
    dPt->Fill(zee.Pt(),weight);
