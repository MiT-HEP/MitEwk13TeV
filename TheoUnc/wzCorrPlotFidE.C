...
void wzCorrPlotFidE() {
  ...
  CorrPlot plot("cplot","","#sigma^{fid}_{W}xBR(W#rightarrow e#nu) [pb]","#sigma^{fid}_{Z}xBR(Z#rightarrow ee) [pb]",7900,9500,580,700);

  Double_t w_acc_nnpdf = 0.43484668;
  Double_t z_acc_nnpdf = 0.333847;
  Double_t w_acc_mmht = 0.4336721;
  Double_t z_acc_mmht = 0.3333537;
  Double_t w_acc_cteq = 0.43452657;
  Double_t z_acc_cteq = 0.333853;
  Double_t w_acc_abm = 0.43906926;
  Double_t z_acc_abm = 0.337383;
  Double_t w_acc_hera = 0.43418852;
  Double_t z_acc_hera = 0.332291;

  Double_t wp_acc_nnpdf = 0.430216;
  Double_t wm_acc_nnpdf = 0.441115;
  Double_t wp_acc_mmht = 0.428566;
  Double_t wm_acc_mmht = 0.440556;
  Double_t wp_acc_cteq = 0.429192;
  Double_t wm_acc_cteq = 0.441728;
  Double_t wp_acc_abm = 0.428936;
  Double_t wm_acc_abm = 0.449703;
  Double_t wp_acc_hera = 0.426854;
  Double_t wm_acc_hera = 0.444112;
  ...
  Double_t w_xs_meas = 8728.24;
  Double_t z_xs_meas = 640.652;

  //statistical
  Double_t w_stat = 53.921;
  Double_t z_stat = 5.34155;

  //lepton reco+id uncertainties
  Double_t we_lep = 1.589151*0.01;
  Double_t ze_lep = 2.370844*0.01;

  //background subtraction/modeling
  Double_t we_bkg = 1.372443*0.01;
  Double_t ze_bkg = 0.64*0.01;

  //lumi
  Double_t w_lumi = 418.757;
  Double_t z_lumi = 30.7139;
  ...
  comPM(folder+"/wpe_abm.txt",
	folder+"/wme_abm.txt",
	wp_xs_abm, wm_xs_abm, 
	abm_w);

  std::vector<Double_t> abm_z;
  toVec(folder+"/zee_abm.txt",
	abm_z);
  ...
  comPM(folder+"/wpe_hera.txt",
	folder+"/wme_hera.txt",
	wp_xs_hera, wm_xs_hera, 
	hera_w);

  std::vector<Double_t> hera_z;
  toVec(folder+"/zee_hera.txt",
	hera_z);
  ...
  plot.Draw(c1, "wz_fid_ele.png",43);
