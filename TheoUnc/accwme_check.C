...
void accwme_check(TString input="/afs/cern.ch/work/j/jlawhorn/PYTHIA-GEN-SIM/CT10nlo_rw/wme-bacon.root",
  ...
  for (Int_t i=0; i<10; i++) {
    ...
    cout << endl;
    cout << info->xPDF_1 << " " << info->xPDF_2 << " " << info->weight << endl;
    cout << nomPdf->xfxQ(id_1, info->x_1, info->scalePDF) << " " << nomPdf->xfxQ(id_2, info->x_2, info->scalePDF) << endl;
