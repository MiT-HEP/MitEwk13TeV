...
do
    ...
    root -l -q calcUncertCT10.C+\(\"${ACC_DIR}/${CHAN}_parse_ct10nlo.txt\",\"${ACC_DIR}/${CHAN}_parse_ct10nlo_as.txt\"\)
    ...
    root -l -q calcUncertNNPDF23.C+\(\"${ACC_DIR}/${CHAN}_parse_nnpdf23_nlo.txt\"\)
    ...
    awk '/Tot.*/ {print $3 }' ${ACC_DIR}/${CHAN}_mstw2008nlo68cl_asmz-68cl.txt > ${ACC_DIR}/${CHAN}_parse_mstw2008nlo68cl_asmz-68cl.txt
    awk '/Tot.*/ {print $3 }' ${ACC_DIR}/${CHAN}_mstw2008nlo68cl_asmz-68clhalf.txt > ${ACC_DIR}/${CHAN}_parse_mstw2008nlo68cl_asmz-68clhalf.txt
    root -l -q calcUncertMSTW2008.C+\(\"${ACC_DIR}/${CHAN}_parse_mstw2008nlo68cl.txt\",\"${ACC_DIR}/${CHAN}_parse_mstw2008nlo68cl_asmz+68cl.txt\",\"${ACC_DIR}/${CHAN}_parse_mstw2008nlo68cl_asmz+68clhalf.txt\",\"${ACC_DIR}/${CHAN}_parse_mstw2008nlo68cl_asmz-68cl.txt\",\"${ACC_DIR}/${CHAN}_parse_mstw2008nlo68cl_asmz-68clhalf.txt\"\)
