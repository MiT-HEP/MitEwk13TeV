...
void wzCorrPlotFidM() {
  ...
  Double_t wpe_yield=169662;
  Double_t wme_yield=130277;

  Double_t ze_yield=23666;

  //measured cross sections
  Double_t w_xs_meas = 9.13;
  Double_t z_xs_meas = 0.70;

  //statistical
  Double_t w_stat = 0.04;
  Double_t z_stat = 0.01;

  //lepton reco+id uncertainties
  Double_t we_lep = 1.0*0.01;
  Double_t ze_lep = 1.9*0.01;

  //background subtraction/modeling
  Double_t we_bkg = 0.1*0.01;
  Double_t ze_bkg = 0.1*0.01;

  //theory
  Double_t we_theo = 1.3*0.01;
  Double_t ze_theo = 1.1*0.01;

  //lumi
  Double_t w_lumi = 1.10;
