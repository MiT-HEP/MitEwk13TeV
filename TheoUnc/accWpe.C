...
void accWpe(const TString input="/afs/cern.ch/work/j/jlawhorn/PYTHIA-GEN-SIM/Wpe_bacon.root") {
  ...
  for (Int_t i=0; i<chain.GetEntries(); i++) {
    ...
    //if (post1->pt>25 && ((fabs(post1->eta)<1.4442) || (fabs(post1->eta)>1.566 && fabs(post1->eta)<2.5))) {
