...
# root -l -q -b selectWe.C+\(\"we0_13.conf\",\"${NTUPDIR}/Wenu\",1,0,0,1,${NSEC},${ITH}\)
# root -l -q -b selectWe.C+\(\"wx0_13.conf\",\"${NTUPDIR}/Wenu\",1,0,0,1,${NSEC},${ITH}\)
...
# root -l -q -b selectAntiWe.C+\(\"we0_13.conf\",\"${NTUPDIR}/AntiWenu_2015Iso\",1,0,0,1,${NSEC},${ITH}\)
# root -l -q -b selectAntiWe.C+\(\"wx0_13.conf\",\"${NTUPDIR}/AntiWenu_2015Iso\",1,0,0,1,${NSEC},${ITH}\)
# root -l -q -b selectAntiWe.C+\(\"we_13.conf\",\"${NTUPDIR}/AntiWenu_dEta_dPhi\",1,0,0,1,${NSEC},${ITH}\)
