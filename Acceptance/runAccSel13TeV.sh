...
OUTDIR=/afs/cern.ch/user/s/sabrandt/work/public/FilesSM2017GH/Acceptance/AccSel_13TeV_noCut
...
# Z->mumu
  ...
  # root -l -q computeAccSelZmmBinned_Sys.C+\(\"z_13.conf\",\"${EFFDIR}/Zmm/\",\"${OUTDIR}/Zmm_13TeV_wEff${SYS}\",0,\"${SIT}\",\"${Sta}\",1\)
...
# EFFDIR="/afs/cern.ch/user/s/sabrandt/work/public/FilesSM2017GH/Efficiency/LowPU2017ID_13TeV/results"
# EFFDIR="/afs/cern.ch/user/s/sabrandt/work/public/FilesSM2017GH/Efficiency/LowPU2017ID_13TeV/results/old/Zee_EleTightID/"
# root -l -q computeAccSelWe_Sys.C+\(\"w0j_13.conf\",\"${EFFDIR}/Zee/\",\"${OUTDIR}/Wep_0j_13TeV_wEff${SYS}\",1,0,1,0,\"${GSF}\",1\)
# root -l -q computeAccSelWe_Sys.C+\(\"w1j_13.conf\",\"${EFFDIR}/Zee/\",\"${OUTDIR}/Wep_1j_13TeV_wEff${SYS}\",1,0,1,0,\"${GSF}\",1\)
# root -l -q computeAccSelWe_Sys.C+\(\"w2j_13.conf\",\"${EFFDIR}/Zee/\",\"${OUTDIR}/Wep_2j_13TeV_wEff${SYS}\",1,0,1,0,\"${GSF}\",1\)

# root -l -q computeAccSelWe_Sys.C+\(\"w0j_13.conf\",\"${EFFDIR}/Zee/\",\"${OUTDIR}/Wem_0j_13TeV_wEff${SYS}\",-1,0,1,0,\"${GSF}\",1\)
# root -l -q computeAccSelWe_Sys.C+\(\"w1j_13.conf\",\"${EFFDIR}/Zee/\",\"${OUTDIR}/Wem_1j_13TeV_wEff${SYS}\",-1,0,1,0,\"${GSF}\",1\)
# root -l -q computeAccSelWe_Sys.C+\(\"w2j_13.conf\",\"${EFFDIR}/Zee/\",\"${OUTDIR}/Wem_2j_13TeV_wEff${SYS}\",-1,0,1,0,\"${GSF}\",1\)

# # #
# # # Z->ee
# # #
root -l -q computeAccSelZeeBinned_Sys.C+\(\"z_13.conf\",\"${EFFDIR}/Zee/\",\"${OUTDIR}/Zee_13TeV_wEff${SYS}_check\",\"${S13}\",0,1,0,\"${GSF}\",1\)
