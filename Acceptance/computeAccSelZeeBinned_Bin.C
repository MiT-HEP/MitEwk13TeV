...
void computeAccSelZeeBinned_Bin(const TString conf,            // input file
  ...
  // efficiency files
  const TString dataHLTEffName     = inputDir+"EleHLTEff/1MG/eff.root";
  const TString dataHLTEffName_pos = inputDir+"EleHLTEff/1MG/eff.root";
  const TString dataHLTEffName_neg = inputDir+"EleHLTEff/1MG/eff.root";

  const TString zeeHLTEffName      = inputDir+"EleHLTEff/1CT/eff.root";
  const TString zeeHLTEffName_pos  = inputDir+"EleHLTEff/1CT/eff.root";
  const TString zeeHLTEffName_neg  = inputDir+"EleHLTEff/1CT/eff.root";
  
  const TString dataGsfSelEffName     = inputDir+"EleGsfSelEff/1MG/eff.root";
  const TString dataGsfSelEffName_pos = inputDir+"EleGsfSelEff/1MG/eff.root";
  const TString dataGsfSelEffName_neg = inputDir+"EleGsfSelEff/1MG/eff.root";

  const TString zeeGsfSelEffName      = inputDir+"EleGsfSelEff/1CT/eff.root";
  const TString zeeGsfSelEffName_pos  = inputDir+"EleGsfSelEff/1CT/eff.root";
  const TString zeeGsfSelEffName_neg  = inputDir+"EleGsfSelEff/1CT/eff.root";
