...
plotAntiMetm.SetYRange(0.1,1500);
  ...
  cout << "   " << hDataMet->Integral() << endl;
  cout << "   " << hAntiDataMet->Integral() << endl;

  cout << "Selected (datap): " << endl;
  cout << "   " << hDataMetp->Integral() << endl;
  cout << "   " << hAntiDataMetp->Integral() << endl;

  cout << "Selected (datam): " << endl;
  cout << "   " << hDataMetm->Integral() << endl;
  cout << "   " << hAntiDataMetm->Integral() << endl;

  // Initial values for yields in Combine

  cout << "Starting values for Wmunu yields: " << endl;
  cout << "   sig: " << hWmunuMet->Integral() << endl;
  cout << "   EWK: " << hEWKMet->Integral() << endl;
  cout << "   qcd: " << hDataMet->Integral()-hWmunuMet->Integral()-hEWKMet->Integral() << endl; // 0.3*hDataMet->Integral() << endl;
  cout << "Starting values for AntiWmunu yields: " << endl;
  cout << "   sig: " << hAntiWmunuMet->Integral() << endl;
  cout << "   EWK: " << hAntiEWKMet->Integral() << endl;
  cout << "   qcd: " << hAntiDataMet->Integral()-hAntiWmunuMet->Integral()-hAntiEWKMet->Integral() << endl; // 0.9*hAntiDataMet->Integral() << endl;

  cout << "Starting values for Wmunu_p yields: " << endl;
  cout << "   sig: " << hWmunuMetp->Integral() << endl;
  cout << "   EWK: " << hEWKMetp->Integral() << endl;
  cout << "   qcd: " << hDataMetp->Integral()-hWmunuMetp->Integral()-hEWKMetp->Integral() << endl; // 0.3*hDataMetp->Integral() << endl;
  cout << "Starting values for AntiWmunu_p yields: " << endl;
  cout << "   sig: " << hAntiWmunuMetp->Integral() << endl;
  cout << "   EWK: " << hAntiEWKMetp->Integral() << endl;
  cout << "   qcd: " << hAntiDataMetp->Integral()-hAntiWmunuMetp->Integral()-hAntiEWKMetp->Integral() << endl; // 0.9*hAntiDataMetp->Integral() << endl;

  cout << "Starting values for Wmunu_m yields: " << endl;
  cout << "   sig: " << hWmunuMetm->Integral() << endl;
  cout << "   EWK: " << hEWKMetm->Integral() << endl;
  cout << "   qcd: " << hDataMetm->Integral()-hWmunuMetm->Integral()-hEWKMetm->Integral() << endl; // 0.3*hDataMetm->Integral() << endl;
  cout << "Starting values for AntiWmunu_m yields: " << endl;
  cout << "   sig: " << hAntiWmunuMetm->Integral() << endl;
  cout << "   EWK: " << hAntiEWKMetm->Integral() << endl;
  cout << "   qcd: " << hAntiDataMetm->Integral()-hAntiWmunuMetm->Integral()-hAntiEWKMetm->Integral() << endl; // 0.9*hAntiDataMetm->Integral() << endl;
