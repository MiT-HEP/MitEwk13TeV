...
void fitRecoilZee(TString infilename="/data/blue/Bacon/Run2/wz_flat/Zmumu/ntuples/data_select.root",  // input ntuple
...
//   
  ...
  // 13 TeV
  fnamev.push_back("/afs/cern.ch/user/s/sabrandt/work/public/SM/ZeeForFootprint/top_select.root"); isBkgv.push_back(kTRUE);
  ...
  for(UInt_t ifile=0; ifile<fnamev.size(); ifile++) {
    ...
    intree->SetBranchAddress("puppiMet",	       &met);        // Uncorrected PF MET
