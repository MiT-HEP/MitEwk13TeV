...
void fitRecoilZeeDoubleGauss(TString infilename="/data/blue/Bacon/Run2/wz_flat/Zee/ntuples/data_select.root",  // input ntuple
  ...
  Double_t ptbins[] = {0,10,20,30,40,50,60,80,100};
...
//   fnamev.push_back("/data/blue/Bacon/Run2/wz_flat_07_23/Zee/ntuples/zxx_select.root"); isBkgv.push_back(kTRUE);
  ...
  // for the pf zee corrections
  // ----------
//    fcnPFu1sigma1->SetParameter(0,0); fcnPFu1sigma1->SetParLimits(0,-1e-3,1e-3);
...
// // //   
//     fcnPFu1sigma2->SetParameter(0,-1e-5);  fcnPFu1sigma2->SetParLimits(0,-2e-2,2e-2);
...
// // //   
//     fcnPFu1sigma0->SetParameter(0,0); fcnPFu1sigma0->SetParLimits(0,-1e-4,1e-4);
...
// // //   
// // //   
//    fcnPFu2sigma1->SetParameter(0,-1e-5);  fcnPFu2sigma1->SetParLimits(0,-5e-3,0);
...
// // //   
//    fcnPFu2sigma2->SetParameter(0,0);  fcnPFu2sigma2->SetParLimits(0,-5e-3,5e-3);
...
// // //   
//    fcnPFu2sigma0->SetParameter(0,0);  fcnPFu2sigma0->SetParLimits(0,-1e-2,1e-2);
...
// //   fcnPFu2frac2->SetParameter(2,7);     fcnPFu2frac2->SetParLimits(2,5,9); 
  ...
  // PUPPI Zee DATA corrections
  
     fcnPFu1sigma1->SetParameter(0,0); fcnPFu1sigma1->SetParLimits(0,-1e-3,1e-3);
//   fcnPFu1sigma1->SetParameter(1,0.07);  fcnPFu1sigma1->SetParLimits(1,-1,1);
//   fcnPFu1sigma1->SetParameter(2,5.5);   fcnPFu1sigma1->SetParLimits(2,3,7);
// //   
    fcnPFu1sigma2->SetParameter(0,-52e-5);  fcnPFu1sigma2->SetParLimits(0,-2e-3,2e-2);
    fcnPFu1sigma2->SetParameter(1,0.06);  fcnPFu1sigma2->SetParLimits(1,-1,1);
    fcnPFu1sigma2->SetParameter(2,12);   fcnPFu1sigma2->SetParLimits(2,5,12.5);
// //   
    fcnPFu1sigma0->SetParameter(0,0); fcnPFu1sigma0->SetParLimits(0,-1e-4,1e-4);
//   fcnPFu1sigma0->SetParameter(1,0.07);  fcnPFu1sigma0->SetParLimits(1,-1,1);
//   fcnPFu1sigma0->SetParameter(2,7);     fcnPFu1sigma0->SetParLimits(2,5,9); 
...
// //   
// //   
//    fcnPFu2sigma1->SetParameter(0,-1e-5);  fcnPFu2sigma1->SetParLimits(0,-5e-3,5e3);
//    fcnPFu2sigma1->SetParameter(1,0.05);   fcnPFu2sigma1->SetParLimits(1,-1,1);
//    fcnPFu2sigma1->SetParameter(2,5);      fcnPFu2sigma1->SetParLimits(2,2,7);
// //   
    fcnPFu2sigma2->SetParameter(0,0);  fcnPFu2sigma2->SetParLimits(0,-5e-3,5e-3);
