...
void fitRecoilWe(TString infoldername,  // input ntuple
...
//  fcnPFu1sigma1->SetParameter(0,-5e-5); fcnPFu1sigma1->SetParLimits(0,-1e-3,0);
...
//  fcnPFu1sigma0->SetParameter(0,-1e-4); fcnPFu1sigma0->SetParLimits(0,-1e-3,0);
//  fcnPFu1sigma0->SetParameter(1,0.03);  fcnPFu1sigma0->SetParLimits(1,0,0.1);
...
//  fcnPFu2sigma1->SetParameter(2,5);     fcnPFu2sigma1->SetParLimits(2,4,6);
//  fcnPFu2sigma2->SetParameter(0,-2e-5); fcnPFu2sigma2->SetParLimits(0,-3e-4,4e-4);
...
//  fcnPFu2sigma0->SetParameter(0,-1e-4); fcnPFu2sigma0->SetParLimits(0,-1e-3,0);
//  fcnPFu2sigma0->SetParameter(1,0.03);  fcnPFu2sigma0->SetParLimits(1,0,0.1);
