...
# root -l -b -q fitRecoilZmm.C+\(\"${INPUTDIR}/Zmumu/ntuples/data_select.root\",3,3,0,\"u1\",\"u2\",\"met\",\"ZmmDataPF_bkgTopEWK_lowPU13\",${LUMI},0\)  #Zmumu data/ /BKG selection selection
