...
root -l -b -q fitRecoilWm.C+\(\"${INPUTDIR}\",3,3,1,1,0,\"u1\",\"u2\",\"met\",\"LowPU2017ID_13TeV_WmpMCPF\",${LUMI},0\)  #Wmp MC
# root -l -b -q fitRecoilWm.C+\(\"${INPUTDIR}\",3,3,1,-1,0,\"u1\",\"u2\",\"met\",\"LowPU2017ID_13TeV_WmmMCPF\",${LUMI},0\)  #Wmm MC
# root -l -b -q fitRecoilZmm.C+\(\"${INPUTDIR}/Zmumu/ntuples/zmm_select.raw.root\",3,3,1,\"u1\",\"u2\",\"met\",\"LowPU2017ID_13TeV_ZmmMCPF\",${LUMI},0\)  #Zmumu MC
# root -l -b -q fitRecoilZmm.C+\(\"${INPUTDIR}/Zmumu/ntuples/data_select.root\",3,3,0,\"u1\",\"u2\",\"met\",\"LowPU2017ID_13TeV_ZmmDataPF\",${LUMI},0\)  #Zmumu data incl Bkg
