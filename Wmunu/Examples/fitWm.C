...
void fitWm(const TString  outputDir,   // output directory
  ...
  // recoil correction
  RecoilCorrector recoilCorr("../Recoil/ZmmDataMay23_2/fits.root");//, (!) uncomment to perform corrections to recoil from W-MC/Z-MC
  ...
  TH1D *hWmunuMet_5GeV  = new TH1D("hWmunuMet_5GeV","", NBINS,0,METMAX); hWmunuMet_5GeV->Sumw2();
  TH1D *hWmunuMetp_5GeV = new TH1D("hWmunuMetp_5GeV","",NBINS,0,METMAX); hWmunuMetp_5GeV->Sumw2();
  TH1D *hWmunuMetm_5GeV = new TH1D("hWmunuMetm_5GeV","",NBINS,0,METMAX); hWmunuMetm_5GeV->Sumw2();

  TH1D *hWmunuMet_10GeV  = new TH1D("hWmunuMet_10GeV","", NBINS,0,METMAX); hWmunuMet_10GeV->Sumw2();
  TH1D *hWmunuMetp_10GeV = new TH1D("hWmunuMetp_10GeV","",NBINS,0,METMAX); hWmunuMetp_10GeV->Sumw2();
  TH1D *hWmunuMetm_10GeV = new TH1D("hWmunuMetm_10GeV","",NBINS,0,METMAX); hWmunuMetm_10GeV->Sumw2();

  TH1D *hWmunuMet_15GeV  = new TH1D("hWmunuMet_15GeV","", NBINS,0,METMAX); hWmunuMet_15GeV->Sumw2();
  TH1D *hWmunuMetp_15GeV = new TH1D("hWmunuMetp_15GeV","",NBINS,0,METMAX); hWmunuMetp_15GeV->Sumw2();
  TH1D *hWmunuMetm_15GeV = new TH1D("hWmunuMetm_15GeV","",NBINS,0,METMAX); hWmunuMetm_15GeV->Sumw2();

  TH1D *hAntiWmunuMet_5GeV  = new TH1D("hAntiWmunuMet_5GeV","", NBINS,0,METMAX); hAntiWmunuMet_5GeV->Sumw2();
  TH1D *hAntiWmunuMetp_5GeV = new TH1D("hAntiWmunuMetp_5GeV","",NBINS,0,METMAX); hAntiWmunuMetp_5GeV->Sumw2();
  TH1D *hAntiWmunuMetm_5GeV = new TH1D("hAntiWmunuMetm_5GeV","",NBINS,0,METMAX); hAntiWmunuMetm_5GeV->Sumw2();

  TH1D *hAntiWmunuMet_10GeV  = new TH1D("hAntiWmunuMet_10GeV","", NBINS,0,METMAX); hAntiWmunuMet_10GeV->Sumw2();
  TH1D *hAntiWmunuMetp_10GeV = new TH1D("hAntiWmunuMetp_10GeV","",NBINS,0,METMAX); hAntiWmunuMetp_10GeV->Sumw2();
  TH1D *hAntiWmunuMetm_10GeV = new TH1D("hAntiWmunuMetm_10GeV","",NBINS,0,METMAX); hAntiWmunuMetm_10GeV->Sumw2();

  TH1D *hAntiWmunuMet_15GeV  = new TH1D("hAntiWmunuMet_15GeV","", NBINS,0,METMAX); hAntiWmunuMet_15GeV->Sumw2();
  TH1D *hAntiWmunuMetp_15GeV = new TH1D("hAntiWmunuMetp_15GeV","",NBINS,0,METMAX); hAntiWmunuMetp_15GeV->Sumw2();
  TH1D *hAntiWmunuMetm_15GeV = new TH1D("hAntiWmunuMetm_15GeV","",NBINS,0,METMAX); hAntiWmunuMetm_15GeV->Sumw2();
  ...
  for(UInt_t ifile=0; ifile<fnamev.size(); ifile++) {
    ...
    for(UInt_t ientry=0; ientry<intree->GetEntries(); ientry++) {
      ...
      Double_t smearMETx=0, smearMETy=0, METres = 0.0;
      TVector2 smearMET;
	...
	if(typev[ifile]==eWmunu) {
	  ...
	  hWmunuMet->Fill(corrMet,weight);
          hWmunuMet_5GeV->Fill(corrMet_5GeV,weight);
          hWmunuMet_10GeV->Fill(corrMet_10GeV,weight);
          hWmunuMet_15GeV->Fill(corrMet_15GeV,weight);
	  if(q>0) { hWmunuMetp->Fill(corrMet,weight);} 
	  else    { hWmunuMetm->Fill(corrMet,weight); }
	  if(q>0) { hWmunuMetp_5GeV->Fill(corrMet_5GeV,weight);} 
	  else    { hWmunuMetm_5GeV->Fill(corrMet_5GeV,weight); }
	  if(q>0) { hWmunuMetp_10GeV->Fill(corrMet_10GeV,weight);} 
	  else    { hWmunuMetm_10GeV->Fill(corrMet_10GeV,weight); }
	  if(q>0) { hWmunuMetp_15GeV->Fill(corrMet_15GeV,weight);} 
	  else    { hWmunuMetm_15GeV->Fill(corrMet_15GeV,weight); }
        }
	if(typev[ifile]==eAntiWmunu) {
	  ...
	  hAntiWmunuMet->Fill(corrMet,weight);
          hAntiWmunuMet_5GeV->Fill(corrMet_5GeV,weight);
          hAntiWmunuMet_10GeV->Fill(corrMet_10GeV,weight);
          hAntiWmunuMet_15GeV->Fill(corrMet_15GeV,weight);
	  if(q>0) { hAntiWmunuMetp->Fill(corrMet,weight); } 
	  else    { hAntiWmunuMetm->Fill(corrMet,weight); }
	  if(q>0) { hAntiWmunuMetp_5GeV->Fill(corrMet_5GeV,weight); } 
	  else    { hAntiWmunuMetm_5GeV->Fill(corrMet_5GeV,weight); }
	  if(q>0) { hAntiWmunuMetp_10GeV->Fill(corrMet_10GeV,weight); } 
	  else    { hAntiWmunuMetm_10GeV->Fill(corrMet_10GeV,weight); }
	  if(q>0) { hAntiWmunuMetp_15GeV->Fill(corrMet_15GeV,weight); } 
	  else    { hAntiWmunuMetm_15GeV->Fill(corrMet_15GeV,weight); }
        }
        if(typev[ifile]==eEWK) {
  ...
  cout << " hWmunuMet->Integral(): " << hWmunuMet->Integral() << " and hWmunuMet->GetRMS(): " << hWmunuMet->GetRMS() << endl;
  cout << "hWmunuMetp->Integral(): " << hWmunuMetp->Integral() << endl;
  cout << "hWmunuMetm->Integral(): " << hWmunuMetm->Integral() << endl;
  ...
  cout << " hAntiWmunuMet->Integral(): " << hAntiWmunuMet->Integral() << endl;
  cout << "hAntiWmunuMetp->Integral(): " << hAntiWmunuMetp->Integral() << endl;
  cout << "hAntiWmunuMetm->Integral(): " << hAntiWmunuMetm->Integral() << endl;

  cout << " hAntiEWKMet->Integral(): " << hAntiEWKMet->Integral() << endl;
  cout << "hAntiEWKMetp->Integral(): " << hAntiEWKMetp->Integral() << endl;
  cout << "hAntiEWKMetm->Integral(): " << hAntiEWKMetm->Integral() << endl;
  ...
  RooRealVar nQCDp("nQCDp","nQCDp",0.3*(hDataMet->Integral()),0,hDataMet->Integral());
  ...
  RooRealVar nAntiQCDp("nAntiQCDp","nAntiQCDp",0.9*(hDataMet->Integral()),0,hDataMet->Integral());
  ...
  RooRealVar nQCDm("pepe1Pdf_qcdm_norm","pepe1Pdf_qcdm_norm",0.3*(hDataMet->Integral()),0,hDataMet->Integral());
  ...
  RooRealVar nAntiQCDm("nAntiQCDm","nAntiQCDm",0.9*(hDataMet->Integral()),0,hDataMet->Integral());
  ...
  RooDataHist wmunuMet_5GeV ("wmunuMET_5GeV", "wmunuMET_5GeV", RooArgSet(pfmet),hWmunuMet_5GeV);
  RooDataHist wmunuMetp_5GeV("wmunuMETp_5GeV","wmunuMETp_5GeV",RooArgSet(pfmet),hWmunuMetp_5GeV);
  RooDataHist wmunuMetm_5GeV("wmunuMETm_5GeV","wmunuMETm_5GeV",RooArgSet(pfmet),hWmunuMetm_5GeV);
  RooHistPdf pdfWm_5GeV ("wm_5GeV", "wm_5GeV", pfmet,wmunuMet_5GeV, 1);
  RooHistPdf pdfWmp_5GeV("wmp_5GeV","wmp_5GeV",pfmet,wmunuMetp_5GeV,1);
  RooHistPdf pdfWmm_5GeV("wmm_5GeV","wmm_5GeV",pfmet,wmunuMetm_5GeV,1); 

  RooDataHist wmunuMet_10GeV ("wmunuMET_10GeV", "wmunuMET_10GeV", RooArgSet(pfmet),hWmunuMet_10GeV);
  RooDataHist wmunuMetp_10GeV("wmunuMETp_10GeV","wmunuMETp_10GeV",RooArgSet(pfmet),hWmunuMetp_10GeV);
  RooDataHist wmunuMetm_10GeV("wmunuMETm_10GeV","wmunuMETm_10GeV",RooArgSet(pfmet),hWmunuMetm_10GeV);
  RooHistPdf pdfWm_10GeV ("wm_10GeV", "wm_10GeV", pfmet,wmunuMet_10GeV, 1);
  RooHistPdf pdfWmp_10GeV("wmp_10GeV","wmp_10GeV",pfmet,wmunuMetp_10GeV,1);
  RooHistPdf pdfWmm_10GeV("wmm_10GeV","wmm_10GeV",pfmet,wmunuMetm_10GeV,1);

  RooDataHist wmunuMet_15GeV ("wmunuMET_15GeV", "wmunuMET_15GeV", RooArgSet(pfmet),hWmunuMet_15GeV);
  RooDataHist wmunuMetp_15GeV("wmunuMETp_15GeV","wmunuMETp_15GeV",RooArgSet(pfmet),hWmunuMetp_15GeV);
  RooDataHist wmunuMetm_15GeV("wmunuMETm_15GeV","wmunuMETm_15GeV",RooArgSet(pfmet),hWmunuMetm_15GeV); 
  RooHistPdf pdfWm_15GeV ("wm_15GeV", "wm_15GeV", pfmet,wmunuMet_15GeV, 1);
  RooHistPdf pdfWmp_15GeV("wmp_15GeV","wmp_15GeV",pfmet,wmunuMetp_15GeV,1);
  RooHistPdf pdfWmm_15GeV("wmm_15GeV","wmm_15GeV",pfmet,wmunuMetm_15GeV,1);
...
*/  
  ...
  RooDataHist awmunuMet_5GeV ("awmunuMET_5GeV", "awmunuMET_5GeV", RooArgSet(pfmet),hAntiWmunuMet_5GeV);
  RooDataHist awmunuMetp_5GeV("awmunuMETp_5GeV","awmunuMETp_5GeV",RooArgSet(pfmet),hAntiWmunuMetp_5GeV);
  RooDataHist awmunuMetm_5GeV("awmunuMETm_5GeV","awmunuMETm_5GeV",RooArgSet(pfmet),hAntiWmunuMetm_5GeV);
  RooHistPdf apdfWm_5GeV ("awm_5GeV", "awm_5GeV", pfmet,awmunuMet_5GeV, 1);
  RooHistPdf apdfWmp_5GeV("awmp_5GeV","awmp_5GeV",pfmet,awmunuMetp_5GeV,1);
  RooHistPdf apdfWmm_5GeV("awmm_5GeV","awmm_5GeV",pfmet,awmunuMetm_5GeV,1); 

  RooDataHist awmunuMet_10GeV ("awmunuMET_10GeV", "awmunuMET_10GeV", RooArgSet(pfmet),hAntiWmunuMet_10GeV);
  RooDataHist awmunuMetp_10GeV("awmunuMETp_10GeV","awmunuMETp_10GeV",RooArgSet(pfmet),hAntiWmunuMetp_10GeV);
  RooDataHist awmunuMetm_10GeV("awmunuMETm_10GeV","awmunuMETm_10GeV",RooArgSet(pfmet),hAntiWmunuMetm_10GeV);
  RooHistPdf apdfWm_10GeV ("awm_10GeV", "awm_10GeV", pfmet,awmunuMet_10GeV, 1);
  RooHistPdf apdfWmp_10GeV("awmp_10GeV","awmp_10GeV",pfmet,awmunuMetp_10GeV,1);
  RooHistPdf apdfWmm_10GeV("awmm_10GeV","awmm_10GeV",pfmet,awmunuMetm_10GeV,1);

  RooDataHist awmunuMet_15GeV ("awmunuMET_15GeV", "awmunuMET_15GeV", RooArgSet(pfmet),hAntiWmunuMet_15GeV);
  RooDataHist awmunuMetp_15GeV("awmunuMETp_15GeV","awmunuMETp_15GeV",RooArgSet(pfmet),hAntiWmunuMetp_15GeV);
  RooDataHist awmunuMetm_15GeV("awmunuMETm_15GeV","awmunuMETm_15GeV",RooArgSet(pfmet),hAntiWmunuMetm_15GeV); 
  RooHistPdf apdfWm_15GeV ("awm_15GeV", "awm_15GeV", pfmet,awmunuMet_15GeV, 1);
  RooHistPdf apdfWmp_15GeV("awmp_15GeV","awmp_15GeV",pfmet,awmunuMetp_15GeV,1);
  RooHistPdf apdfWmm_15GeV("awmm_15GeV","awmm_15GeV",pfmet,awmunuMetm_15GeV,1);
...
/*
  for (int jbin=0;jbin<NBINS;jbin++) {
    hAntiQCDMet->SetBinContent(jbin,1);
    hAntiQCDMetp->SetBinContent(jbin,1);
    hAntiQCDMetm->SetBinContent(jbin,1);
  }
  RooDataHist aqcdMet ("aqcdMET", "aqcdMET", RooArgSet(pfmet),hAntiQCDMet);  RooHistPdf aqcd ("pepe1Pdf_aqcd", "pepe1Pdf_aqcd", pfmet,aqcdMet, 1);
  RooDataHist aqcdMetp("aqcdMETp","aqcdMETp",RooArgSet(pfmet),hAntiQCDMetp); RooHistPdf aqcdp("pepe1Pdf_aqcdp","pepe1Pdf_aqcdp",pfmet,aqcdMetp,1);
  RooDataHist aqcdMetm("aqcdMETm","aqcdMETm",RooArgSet(pfmet),hAntiQCDMetm); RooHistPdf aqcdm("pepe1Pdf_aqcdm","pepe1Pdf_aqcdm",pfmet,aqcdMetm,1);
*/  
  // Anti-selection PDFs
...
//  combine_workspace.import(aqcd);          combine_workspace.import(aqcdp);          combine_workspace.import(aqcdm);
  ...
  // Make datacards
/*
  makeDatacard(outputDir,"Wmunu_sel", "tied",cewk.getVal(), nQCD.getVal(), lumi);
  makeDatacard(outputDir,"Wmunup_sel","tied",cewkp.getVal(),nQCDp.getVal(),lumi);
  makeDatacard(outputDir,"Wmunum_sel","tied",cewkm.getVal(),nQCDm.getVal(),lumi);
  makeDatacard(outputDir,"Wmunu_anti", "tied",dewk.getVal(), nAntiQCD.getVal(), lumi);
  makeDatacard(outputDir,"Wmunup_anti","tied",dewkp.getVal(),nAntiQCDp.getVal(),lumi);
  makeDatacard(outputDir,"Wmunum_anti","tied",dewkm.getVal(),nAntiQCDm.getVal(),lumi);
*/
/*
  //
  // Perform fits
