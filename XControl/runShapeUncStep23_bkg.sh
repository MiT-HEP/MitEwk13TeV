...
makePseudoData("${filedir}/${lepton}${efftype}Eff/MG/plots/", "${filedir}/${lepton}${efftype}Eff/PL/plots/", "${binvar}_${binnum}", "${filedir}/${lepton}${efftype}Eff/Step2Output/PL/",${binnum},${binnum},${toynum})
.q
EOF
...
doStep3("${filedir}/${lepton}${efftype}Eff/Step2Output/PL","${binvar}_${binnum}_${psenum}.dat","${filedir}/${lepton}${efftype}Eff/MG/plots/${binvar}_${binnum}.root","${filedir}/${lepton}${efftype}Eff/PL","pl${binvar}_${binnum}")
.q
EOF
rm ${filedir}/${lepton}${efftype}Eff/Step2Output/PL/${binvar}_${binnum}_${psenum}.dat
done
