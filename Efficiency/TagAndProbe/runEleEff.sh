...
# root -l -b -q plotEff.C+\(\"elfineptbins.bins\",0,0,0,0,\"${NTUPLEDIR_13}/Zee/MC/EleHLTEff/probes.root\",\"${OUTPUTDIR_13}/Zee/MC/EleHLTEff_aMCxPythia${POSTFIX}/Negative\",\"png\",0,0,-1,\"Supercluster\",\"supercluster\",0.0,1.15,${LUMI13},\"${NTUPLEDIR_13}/Zee/MC/EleHLTEff/probes.root\"\)
# root -l -b -q plotEff.C+\(\"elfineptbins.bins\",0,0,0,0,\"${NTUPLEDIR_13}/Zee/MC/EleHLTEff/probes.root\",\"${OUTPUTDIR_13}/Zee/MC/EleHLTEff_aMCxPythia${POSTFIX}/Positive\",\"png\",0,0,1,\"Supercluster\",\"supercluster\",0.0,1.15,${LUMI13},\"${NTUPLEDIR_13}/Zee/MC/EleHLTEff/probes.root\"\)
# root -l -b -q plotEff.C+\(\"elfineptbins.bins\",0,0,0,0,\"${NTUPLEDIR_13}/Zee/Data/EleHLTEff/probes.root\",\"${OUTPUTDIR_13}/Zee/Data/EleHLTEff_aMCxPythia${POSTFIX}/Negative\",\"png\",0,0,-1,\"Supercluster\",\"supercluster\",0.0,1.15,${LUMI13},\"${NTUPLEDIR_13}/Zee/MC/EleHLTEff/probes.root\"\)
# root -l -b -q plotEff.C+\(\"elfineptbins.bins\",0,0,0,0,\"${NTUPLEDIR_13}/Zee/Data/EleHLTEff/probes.root\",\"${OUTPUTDIR_13}/Zee/Data/EleHLTEff_aMCxPythia${POSTFIX}/Positive\",\"png\",0,0,1,\"Supercluster\",\"supercluster\",0.0,1.15,${LUMI13},\"${NTUPLEDIR_13}/Zee/MC/EleHLTEff/probes.root\"\)

### Different Tag Pt cut
# root -l -b -q plotEff.C+\(\"elfineptbins.bins\",0,0,0,0,\"${NTUPLEDIR_13}/Zee/MC/EleHLTEff_tagPt/probes.root\",\"${OUTPUTDIR_13}/Zee/MC/EleHLTEff_aMCxPythia${POSTFIX}_tagPt/Negative\",\"png\",0,0,-1,\"Supercluster\",\"supercluster\",0.0,1.15,${LUMI13},\"${NTUPLEDIR_13}/Zee/MC/HLTEff_tagPt/probes.root\"\)
# root -l -b -q plotEff.C+\(\"elfineptbins.bins\",0,0,0,0,\"${NTUPLEDIR_13}/Zee/MC/EleHLTEff_tagPt/probes.root\",\"${OUTPUTDIR_13}/Zee/MC/EleHLTEff_aMCxPythia${POSTFIX}_tagPt/Positive\",\"png\",0,0,1,\"Supercluster\",\"supercluster\",0.0,1.15,${LUMI13},\"${NTUPLEDIR_13}/Zee/MC/HLTEff_tagPt/probes.root\"\)
# root -l -b -q plotEff.C+\(\"elfineptbins.bins\",0,0,0,0,\"${NTUPLEDIR_13}/Zee/Data/EleHLTEff_tagPt/probes.root\",\"${OUTPUTDIR_13}/Zee/Data/EleHLTEff_aMCxPythia${POSTFIX}_tagPt/Negative\",\"png\",0,0,-1,\"Supercluster\",\"supercluster\",0.0,1.15,${LUMI13},\"${NTUPLEDIR_13}/Zee/MC/HLTEff_tagPt/probes.root\"\)
# root -l -b -q plotEff.C+\(\"elfineptbins.bins\",0,0,0,0,\"${NTUPLEDIR_13}/Zee/Data/EleHLTEff_tagPt/probes.root\",\"${OUTPUTDIR_13}/Zee/Data/EleHLTEff_aMCxPythia${POSTFIX}_tagPt/Positive\",\"png\",0,0,1,\"Supercluster\",\"supercluster\",0.0,1.15,${LUMI13},\"${NTUPLEDIR_13}/Zee/MC/HLTEff_tagPt/probes.root\"\)
...
TYPE=_aMCxPythia
# # # # #### Draw Plots
 root -l -b -q plotDataMC_singlepTbins.C+\(\"$OUTPUTDIR_13/Plots/ZeeHLT${TYPE}${POSTFIX}/pt/Negative\",\"$OUTPUTDIR_13/Zee/MC/EleHLTEff${TYPE}${POSTFIX}/Negative/eff.root\",\"$OUTPUTDIR_13/Zee/Data/EleHLTEff${TYPE}${POSTFIX}/Negative/eff.root\",\"PtBins\",0.00,1.20,$LUMI13,\"elfineptbins.bins\"\)
 root -l -b -q plotDataMC_singlepTbins.C+\(\"$OUTPUTDIR_13/Plots/ZeeHLT${TYPE}${POSTFIX}/pt/Positive\",\"$OUTPUTDIR_13/Zee/MC/EleHLTEff${TYPE}${POSTFIX}/Positive/eff.root\",\"$OUTPUTDIR_13/Zee/Data/EleHLTEff${TYPE}${POSTFIX}/Positive/eff.root\",\"PtBins\",0.00,1.20,$LUMI13,\"elfineptbins.bins\"\)
 
 # root -l -b -q plotDataMC_singleEtabins.C+\(\"$OUTPUTDIR_13/Plots/ZeeHLT${TYPE}${POSTFIX}/eta/Negative\",\"$OUTPUTDIR_13/Zee/MC/EleHLTEff${TYPE}${POSTFIX}/Negative/eff.root\",\"$OUTPUTDIR_13/Zee/Data/EleHLTEff${TYPE}${POSTFIX}/Negative/eff.root\",\"EtaBins\",0.00,1.20,$LUMI13,\"elfineptbins.bins\"\)
 # root -l -b -q plotDataMC_singleEtabins.C+\(\"$OUTPUTDIR_13/Plots/ZeeHLT${TYPE}${POSTFIX}/eta/Positive\",\"$OUTPUTDIR_13/Zee/MC/EleHLTEff${TYPE}${POSTFIX}/Positive/eff.root\",\"$OUTPUTDIR_13/Zee/Data/EleHLTEff${TYPE}${POSTFIX}/Positive/eff.root\",\"EtaBins\",0.00,1.20,$LUMI13,\"elfineptbins.bins\"\)
  
 # # root -l -b -q plotDataMC.C+\(\"$OUTPUTDIR_13/Plots/ZeeHLT${POSTFIX}/etapt/Negative\",\"$OUTPUTDIR_13/Zee/MC/HLTEff${POSTFIX}/Negative/eff.root\",\"$OUTPUTDIR_13/Zee/Data/HLTEff${POSTFIX}/Negative/eff.root\",\"EtaPtBins\",0.00,1.20,$LUMI13,\"elfineptbins.bins\"\)
 # # root -l -b -q plotDataMC.C+\(\"$OUTPUTDIR_13/Plots/ZeeHLT${POSTFIX}/etapt/Positive\",\"$OUTPUTDIR_13/Zee/MC/HLTEff${POSTFIX}/Positive/eff.root\",\"$OUTPUTDIR_13/Zee/Data/HLTEff${POSTFIX}/Positive/eff.root\",\"EtaPtBins\",0.00,1.20,$LUMI13,\"elfineptbins.bins\"\)
 
 root -l -b -q plotDataMC_singlepTbins.C+\(\"$OUTPUTDIR_13/Plots/ZeeGSFSel${TYPE}${POSTFIX}/pt/Negative\",\"$OUTPUTDIR_13/Zee/MC/EleGSFSelEff${TYPE}${POSTFIX}/Negative/eff.root\",\"$OUTPUTDIR_13/Zee/Data/EleGSFSelEff${TYPE}${POSTFIX}/Negative/eff.root\",\"PtBins\",0.00,1.20,$LUMI13,\"elfineptbins.bins\"\)
 root -l -b -q plotDataMC_singlepTbins.C+\(\"$OUTPUTDIR_13/Plots/ZeeGSFSel${TYPE}${POSTFIX}/pt/Positive\",\"$OUTPUTDIR_13/Zee/MC/EleGSFSelEff${TYPE}${POSTFIX}/Positive/eff.root\",\"$OUTPUTDIR_13/Zee/Data/EleGSFSelEff${TYPE}${POSTFIX}/Positive/eff.root\",\"PtBins\",0.00,1.20,$LUMI13,\"elfineptbins.bins\"\)
 
 # root -l -b -q plotDataMC_singleEtabins.C+\(\"$OUTPUTDIR_13/Plots/ZeeGSFSel${TYPE}${POSTFIX}/eta/Negative\",\"$OUTPUTDIR_13/Zee/MC/EleGSFSelEff${TYPE}${POSTFIX}/Negative/eff.root\",\"$OUTPUTDIR_13/Zee/Data/EleGSFSelEff${TYPE}${POSTFIX}/Negative/eff.root\",\"EtaBins\",0.00,1.20,$LUMI13,\"elfineptbins.bins\"\)
 # root -l -b -q plotDataMC_singleEtabins.C+\(\"$OUTPUTDIR_13/Plots/ZeeGSFSel${TYPE}${POSTFIX}/eta/Positive\",\"$OUTPUTDIR_13/Zee/MC/EleGSFSelEff${TYPE}${POSTFIX}/Positive/eff.root\",\"$OUTPUTDIR_13/Zee/Data/EleGSFSelEff${TYPE}${POSTFIX}/Positive/eff.root\",\"EtaBins\",0.00,1.20,$LUMI13,\"elfineptbins.bins\"\)
 
 # root -l -b -q plotDataMC.C+\(\"$OUTPUTDIR_13/Plots/ZeeGSFSel${POSTFIX}/etapt/Negative\",\"$OUTPUTDIR_13/Zee/MC/GSFSelEff${POSTFIX}/Negative/eff.root\",\"$OUTPUTDIR_13/Zee/Data/GSFSelEff${POSTFIX}/Negative/eff.root\",\"EtaPtBins\",0.00,1.20,$LUMI13,\"elfineptbins.bins\"\)
 # root -l -b -q plotDataMC.C+\(\"$OUTPUTDIR_13/Plots/ZeeGSFSel${POSTFIX}/etapt/Positive\",\"$OUTPUTDIR_13/Zee/MC/GSFSelEff${POSTFIX}/Positive/eff.root\",\"$OUTPUTDIR_13/Zee/Data/GSFSelEff${POSTFIX}/Positive/eff.root\",\"EtaPtBins\",0.00,1.20,$LUMI13,\"elfineptbins.bins\"\)
#####################################################################
# Electron efficiencies
