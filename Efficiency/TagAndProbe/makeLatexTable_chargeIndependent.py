...
efftype_caption_map = {'Zee_EleHLTEff':'Electron trigger efficiencies in MC.',
		       ...
		       'Zee_EleSCEff':'Electron supercluster efficiencies in MC.',
                       'DataZee_EleSCEff':'Electron supercluster efficiencies in data.',
		       ...
		       'DataZee_EleGsfEff':'Electron reconstruction efficiencies in data.',
                       ...
                       'Zmm_MuTrkEff':'Tracking efficiencies in MC.',
                       'DataZmm_MuTrkEff':'Tracking efficiencies in data.',
                       'Zmm_MuSelStaEff_iso':'Stand-alone, ID, and isolation muon efficiencies in MC.',
                       'DataZmm_MuSelStaEff_iso':'Stand-alone, ID, and isolation muon efficiencies in data.',
                       'Zmm_MuStaEff_iso':'Stand-alone muon efficiencies in MC.',
                       'DataZmm_MuStaEff_iso':'Stand-alone muon efficiencies in data.'}
