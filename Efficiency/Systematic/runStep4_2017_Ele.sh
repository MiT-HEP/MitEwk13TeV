...
effcb=`grep eff ${filedir}/${dirname}/Data/${lepton}${efftype}Eff${POSTFIX_ALT}/${Charge}/plots/fitres${binvar}_${binnum}.txt | awk '{print $3}'`
# effpl=`grep eff ${filedir}/${dirname}/Data/${lepton}${efftype}Eff${POSTFIX_CB}/${Charge}/plots/fitres${binvar}_${binnum}.txt | awk '{print $3}'`

grep EFFICIENCY ${FILEDIR}/${EFFTYPE}${POSTFIX}${POSTFIX_ALT}_TEST/${CHARGE}/_${binvar}_${binnum} | awk '{diff = $2 - "'"$effcb"'"; pull = diff/$3; print pull }' > ${filedir}/${lepton}${efftype}Eff${POSTFIX}${POSTFIX_ALT}/${CHARGE}/Sig_${binvar}_${binnum}.txt
...
SDrawSystematic("${filedir}/${lepton}${efftype}Eff${POSTFIX}/${CHARGE}/Sig_${binvar}_${binnum}.txt", "${plotdir}", "Sig_${lepton}_${efftype}_${binvar}_${binnum}")

.q
EOF
# SDrawSystematic("${filedir}/${lepton}${efftype}Eff/Bkg_${binvar}_${binnum}.txt", "${plotdir}", "Bkg_${lepton}_${efftype}_${binvar}_${binnum}")
effmg=`grep eff ${filedir}/${dirname}/Data/${lepton}${efftype}Eff${POSTFIX}/${Charge}/plots/fitres${binvar}_${binnum}/fitres${binvar}_${binnum}.txt | awk '{print $3}'`
