...
NTUPLEDIR=/eos/cms/store/group/phys_smp/arapyan/ntuples_after
...
OUT=/afs/cern.ch/work/a/arapyan/public/FilesSM2017GH/SignalExtraction
...
root -l -q -b fitWlnu.C+\(\"${OUT}/TEST_NewEleNtuples_fullMT\",\"${NTUPLEDIR}\",\"Wmunu\",${LUMI13}\);
