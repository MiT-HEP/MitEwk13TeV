...
NTUPLEDIR=/afs/cern.ch/work/s/sabrandt/public/FilesSM2017GH/LowPU2017ID_13TeV_wGM
...
root -l -q fitWlnu.C+\(\"${OUT}/TEST_Wmunu13_wGM_fixHisto\",\"${NTUPLEDIR}\",\"Wmunu\",${LUMI13},${LUMI13}\);
