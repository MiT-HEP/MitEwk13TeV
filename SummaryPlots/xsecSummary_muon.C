...
void xsecSummary_muon()
{   
  //TRandom* gRandom = new TRandom3();
  double rand = 1.0; //gRandom->Gaus(1.0,0.05); 
  //--------------------------------------------------------------------------------------------------------------
  ...
  // input parameter
  double blind=1;
  Double_t xsec_wp = 12225; blind=theo_wp/xsec_wp; xsec_wp=xsec_wp*blind;   const Double_t xsec_wp_stat = 0;   const Double_t xsec_wp_sys =sqrt(pow(89*blind,2)+th_wp*th_wp);   const Double_t xsec_wp_lumi = 208*blind;
  Double_t xsec_wm = 9014; blind=theo_wm/xsec_wm; xsec_wm=xsec_wm*blind;   const Double_t xsec_wm_stat = 0;   const Double_t xsec_wm_sys = sqrt(pow(69*blind,2)+th_wm*th_wm);   const Double_t xsec_wm_lumi = 153*blind;
  Double_t xsec_w  = 21247; blind=theo_w/xsec_w; xsec_w=xsec_w*blind;  const Double_t xsec_w_stat  = 0;   const Double_t xsec_w_sys  = sqrt(pow(130*blind,2)+th_w*th_w);   const Double_t xsec_w_lumi  = 361*blind;
  Double_t xsec_z  = 2012;  blind=theo_z/xsec_z; xsec_z=xsec_z*blind;  const Double_t xsec_z_stat  = 0;    const Double_t xsec_z_sys  = sqrt(pow(19*blind,2)+th_z*th_z);    const Double_t xsec_z_lumi  = 34*blind;
  Double_t xsec_wr = 1.35661; blind=theo_wr/xsec_wr; xsec_wr=xsec_wr*blind;  const Double_t xsec_wr_stat = 0.0;   const Double_t xsec_wr_sys = sqrt(pow(0.006729*blind,2)+th_wr*th_wr); 
  Double_t xsec_wpr= 6.08427; blind=theo_wpr/xsec_wpr; xsec_wpr=xsec_wpr*blind;  const Double_t xsec_wpr_stat= 0.0;   const Double_t xsec_wpr_sys= sqrt(pow(0.04056*blind,2)+th_wmr*th_wmr); 
  Double_t xsec_wmr= 4.48204; blind=theo_wmr/xsec_wmr; xsec_wmr=xsec_wmr*blind;  const Double_t xsec_wmr_stat= 0.0;   const Double_t xsec_wmr_sys= sqrt(pow(0.0301*blind,2)+th_wpr*th_wpr); 
  Double_t xsec_wz = 10.5747; blind=theo_wz/xsec_wz; xsec_wz=xsec_wz*blind;  const Double_t xsec_wz_stat = 0.0;   const Double_t xsec_wz_sys = sqrt(pow(0.0707*blind,2)+th_wz*th_wz); 
  ...
  c->SaveAs("xsecSummary13TeV_muon.png");
  c->SaveAs("xsecSummary13TeV_muon.pdf");
}
