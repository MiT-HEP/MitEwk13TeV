...
void xsecSummary_atlas()
{   
  //--------------------------------------------------------------------------------------------------------------
  // input parameter
  const Double_t xsec_wp = 12225;   const Double_t xsec_wp_stat = 0;   const Double_t xsec_wp_sys =89;   const Double_t xsec_wp_lumi = 208;
  const Double_t xsec_wm = 9014;    const Double_t xsec_wm_stat = 0;   const Double_t xsec_wm_sys = 69;   const Double_t xsec_wm_lumi = 153;
  const Double_t xsec_w  = 21247;   const Double_t xsec_w_stat  = 0;   const Double_t xsec_w_sys  = 130;   const Double_t xsec_w_lumi  = 361;
  const Double_t xsec_z  = 2012;    const Double_t xsec_z_stat  = 0;    const Double_t xsec_z_sys  = 19;    const Double_t xsec_z_lumi  = 34;
  ...
  const Double_t theo_wp = 11830;   const Double_t theo_wp_unc = 320;
  const Double_t theo_wm = 8790;   const Double_t theo_wm_unc = 240;
  const Double_t theo_w  = 20640;   const Double_t theo_w_unc  = 550;
  const Double_t theo_z  = 1991;   const Double_t theo_z_unc  = 38;
  const Double_t theo_wr = theo_wp/theo_wm;   const Double_t theo_wr_unc = 0.01;
  const Double_t theo_wpr= 0.0;   const Double_t theo_wpr_unc= 0.005;
  const Double_t theo_wmr= 0.0;   const Double_t theo_wmr_unc= 0.0033;
  const Double_t theo_wz = theo_w/theo_z;  const Double_t theo_wz_unc = 0.2;
  ...
  tb5.SetBorderSize(0);
  tb5.SetTextAlign(12);
  tb5.AddText("ratio of CMS/ATLAS");
  tb5.Draw();
