...
// root -q -L xsecFidElectronSummary.C
...
void xsecFidElectronSummary()
{   
  //--------------------------------------------------------------------------------------------------------------
  // input parameter
  const Double_t xsec_wp = 4804;     const Double_t xsec_wp_stat = 9;    const Double_t xsec_wp_sys = 114;    const Double_t xsec_wp_lumi = 130;
  const Double_t xsec_wm = 3563;     const Double_t xsec_wm_stat = 6;    const Double_t xsec_wm_sys = 69;    const Double_t xsec_wm_lumi = 96;
  const Double_t xsec_w  = 8367;     const Double_t xsec_w_stat  = 11;     const Double_t xsec_w_sys  = 176;    const Double_t xsec_w_lumi  = 226;
  const Double_t xsec_z  = 635;     const Double_t xsec_z_stat  = 1;    const Double_t xsec_z_sys  = 14;    const Double_t xsec_z_lumi  = 17;
  const Double_t xsec_wr = 1.348;     const Double_t xsec_wr_stat = 0.003;  const Double_t xsec_wr_sys = 0.016; 
  const Double_t xsec_wpr= 7.568;     const Double_t xsec_wpr_stat= 0.016;   const Double_t xsec_wpr_sys= 0.151; 
  const Double_t xsec_wmr= 5.613;     const Double_t xsec_wmr_stat= 0.012;  const Double_t xsec_wmr_sys= 0.092; 
  const Double_t xsec_wz = 13.181;     const Double_t xsec_wz_stat = 0.022  ;  const Double_t xsec_wz_sys = 0.232; 

  const Double_t theo_wp = 4873.83 ;    const Double_t theo_wp_unc = (138.35+158.73)/2.;
  const Double_t theo_wm = 3691.73 ;    const Double_t theo_wm_unc = (107.21+152.00)/2.;
  const Double_t theo_w  = 8565.43 ;    const Double_t theo_w_unc  = (238.05+341.62)/2.;
  const Double_t theo_z  = 623.51;      const Double_t theo_z_unc  = (17.649+23.694)/2.;
  const Double_t theo_wr = 1.32022 ;    const Double_t theo_wr_unc = (0.0272408672+0.02911717)/2. ;
  const Double_t theo_wpr= 7.81565 ;    const Double_t theo_wpr_unc= (0.163156+0.1725639)/2.  ;
  const Double_t theo_wmr= 5.92005 ;    const Double_t theo_wmr_unc= (0.114864+0.120216)/2. ;
  const Double_t theo_wz = 13.7357 ;    const Double_t theo_wz_unc = (0.24455+0.261207)/2. ;
  ...
  textwp.AddText("#bf{W^{+}#rightarrowe^{+}#nu}");
  textwp.Draw(); 
  ...
  textwm.AddText("#bf{W^{-}#rightarrowe^{-}#nu}");
  textwm.Draw(); 
  ...
  textw.AddText("#bf{W#rightarrowe#nu}");
  textw.Draw(); 
  ...
  textz.AddText("#bf{Z#rightarrowe^{+}e^{-}}");
  textz.Draw(); 
  ...
  textwr.AddText("#bf{W^{+}#rightarrowe^{+}#nu / W^{-}#rightarrowe^{-}#nu}");
  textwr.Draw(); 
  ...
  textwpr.AddText("#bf{W^{+}#rightarrowe^{+}#nu / Z#rightarrowe^{+}e^{-}}");
  textwpr.Draw(); 
  ...
  textwmr.AddText("#bf{W^{-}#rightarrowe^{-}#nu / Z#rightarrowe^{+}e^{-}}");
  textwmr.Draw(); 
  ...
  textwz.AddText("#bf{W#rightarrowe#nu / Z#rightarrowe^{+}e^{-}}");
  textwz.Draw(); 
  ...
  c->SaveAs("xsecFidElectronSummary13TeV.png");
  c->SaveAs("xsecFidElectronSummary13TeV.pdf");
}
