...
void xsecSummary_ele_cteq()
{   
  //TRandom* gRandom = new TRandom3();
  double rand = 0.901493; //gRandom->Gaus(1.0,0.05); 
  //--------------------------------------------------------------------------------------------------------------
  // input parameter
  const Double_t xsec_wp = 12167*rand;   const Double_t xsec_wp_stat = 0;   const Double_t xsec_wp_sys =91*rand;   const Double_t xsec_wp_lumi = 207*rand;
  const Double_t xsec_wm = 9006*rand;    const Double_t xsec_wm_stat = 0;   const Double_t xsec_wm_sys = 58*rand;   const Double_t xsec_wm_lumi = 153*rand;
  const Double_t xsec_w  = 21166*rand;   const Double_t xsec_w_stat  = 0;   const Double_t xsec_w_sys  = 133*rand;   const Double_t xsec_w_lumi  = 360*rand;
  const Double_t xsec_z  = 1986*rand;    const Double_t xsec_z_stat  = 0;    const Double_t xsec_z_sys  = 15*rand;    const Double_t xsec_z_lumi  = 34*rand;
  const Double_t xsec_wr = 1.35123;   const Double_t xsec_wr_stat = 0.0;   const Double_t xsec_wr_sys = 0.0101492; 
  const Double_t xsec_wpr= 6.12483;   const Double_t xsec_wpr_stat= 0.0;   const Double_t xsec_wpr_sys= 0.05215; 
  const Double_t xsec_wmr= 4.53371;   const Double_t xsec_wmr_stat= 0.0;   const Double_t xsec_wmr_sys= 0.0387496; 
  const Double_t xsec_wz = 10.6556;  const Double_t xsec_wz_stat = 0.0;   const Double_t xsec_wz_sys = 0.080893; 

  const Double_t theo_wp = 11560;   const Double_t theo_wp_unc = 250;
  const Double_t theo_wm = 8525;   const Double_t theo_wm_unc = 181;
  const Double_t theo_w  = 20085;   const Double_t theo_w_unc  = 426;
  const Double_t theo_z  = 1922;   const Double_t theo_z_unc  = 41;
  const Double_t theo_wr = 1.35619;   const Double_t theo_wr_unc = 0.00989;
  const Double_t theo_wpr= 6.014568;   const Double_t theo_wpr_unc= 0.04;
  const Double_t theo_wmr= 4.435483871;   const Double_t theo_wmr_unc= 0.03;
  const Double_t theo_wz = 10.45;  const Double_t theo_wz_unc = 0.07;
  ...
  c->SaveAs("xsecSummary13TeV_ele_ct18.png");
  c->SaveAs("xsecSummary13TeV_ele_ct18.pdf");
}
