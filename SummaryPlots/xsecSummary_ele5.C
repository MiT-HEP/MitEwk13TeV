...
{   
  ...
  const Double_t th_wp = 4395*0.0053;   
  const Double_t th_wm = 2886*0.0097;  
  const Double_t th_w  = 7280*0.0051;  
  const Double_t th_z  = 683*0.0049;   
  const Double_t th_wr = 1.52291*0.0135;  
  const Double_t th_wpr= 6.43613*0.0096;  
  const Double_t th_wmr= 4.22625*0.0076;   
  const Double_t th_wz = 10.66238*0.0056;  

  // input parameter
  double blind=1;
  Double_t xsec_wp = 4445; blind=theo_wp/xsec_wp; xsec_wp=xsec_wp*blind;  const Double_t xsec_wp_stat = 0;   const Double_t xsec_wp_sys =sqrt(36*36*blind*blind+th_wp*th_wp);   const Double_t xsec_wp_lumi = 213*blind;
  Double_t xsec_wm = 2930; blind=theo_wm/xsec_wm; xsec_wm=xsec_wm*blind;    const Double_t xsec_wm_stat = 0;   const Double_t xsec_wm_sys = sqrt(19*19*blind*blind+th_wm*th_wm);   const Double_t xsec_wm_lumi = 141*blind;
  Double_t xsec_w  = 7377;  blind=theo_w/xsec_w; xsec_w=xsec_w*blind;   const Double_t xsec_w_stat  = 0;   const Double_t xsec_w_sys  = sqrt(31*31*blind*blind+th_w*th_w);   const Double_t xsec_w_lumi  = 354*blind;
  Double_t xsec_z  = 675;  blind=theo_z/xsec_z; xsec_z=xsec_z*blind;  const Double_t xsec_z_stat  = 0;    const Double_t xsec_z_sys  = sqrt(5*5*blind*blind+th_z*th_z);    const Double_t xsec_z_lumi  = 32*blind;
  Double_t xsec_wr = 1.51682;  blind=theo_wr/xsec_wr; xsec_wr=xsec_wr*blind;  const Double_t xsec_wr_stat = 0.0;   const Double_t xsec_wr_sys = sqrt(0.0114218*0.0114218*blind*blind+th_wr*th_wr);
  Double_t xsec_wpr= 6.58361; blind=theo_wpr/xsec_wpr; xsec_wpr=xsec_wpr*blind;  const Double_t xsec_wpr_stat= 0.0;   const Double_t xsec_wpr_sys= sqrt(pow(0.0621096*blind,2)+th_wpr*th_wpr); 
  Double_t xsec_wmr= 4.34344; blind=theo_wmr/xsec_wmr; xsec_wmr=xsec_wmr*blind;  const Double_t xsec_wmr_stat= 0.0;   const Double_t xsec_wmr_sys= sqrt(pow(0.0407835*blind,2)+th_wmr*th_wmr); 
  Double_t xsec_wz = 10.9271; blind=theo_wz/xsec_wz; xsec_wz=xsec_wz*blind; const Double_t xsec_wz_stat = 0.0;   const Double_t xsec_wz_sys = sqrt(pow(0.0926*blind,2)+th_wz*th_wz); 
  ...
  c->SaveAs("xsecSummary5TeV_ele.png");
  c->SaveAs("xsecSummary5TeV_ele.pdf");
}
