...
void xsecFidMuonSummary()
{   
  //--------------------------------------------------------------------------------------------------------------
  // input parameter
  const Double_t xsec_wp = 5097.78;   const Double_t xsec_wp_stat = 3.451;    const Double_t xsec_wp_sys = 47.816;   const Double_t xsec_wp_lumi = 137.640;
  const Double_t xsec_wm = 3866;   const Double_t xsec_wm_stat = 4;    const Double_t xsec_wm_sys = 38;    const Double_t xsec_wm_lumi = 104;
  const Double_t xsec_w  = 8963.546;   const Double_t xsec_w_stat  = 5;    const Double_t xsec_w_sys  = 80;     const Double_t xsec_w_lumi  = 242;
  const Double_t xsec_z  = 691;   const Double_t xsec_z_stat  = 1;    const Double_t xsec_z_sys  = 9 ;    const Double_t xsec_z_lumi  = 19;
  const Double_t xsec_wr = 1.319;   const Double_t xsec_wr_stat = 0.002;  const Double_t xsec_wr_sys = 0.009; 
  const Double_t xsec_wpr= 7.378;   const Double_t xsec_wpr_stat= 0.008;  const Double_t xsec_wpr_sys= 0.052 ; 
  const Double_t xsec_wmr= 5.595;   const Double_t xsec_wmr_stat= 0.007;  const Double_t xsec_wmr_sys= 0.043 ; 
  const Double_t xsec_wz = 12.973;   const Double_t xsec_wz_stat = 0.014;   const Double_t xsec_wz_sys = 0.085; 

  const Double_t theo_wp = 5032.41;   const Double_t theo_wp_unc = (155.72+175.22)/2.;
  const Double_t theo_wm = 3838.06;   const Double_t theo_wm_unc = (116.48+161.61)/2.; 
  const Double_t theo_w  = 8870.35;   const Double_t theo_w_unc  = (243.28+351.53)/2.;
  const Double_t theo_z  = 677.11;    const Double_t theo_z_unc  = (18.838+25.488)/2.;
  const Double_t theo_wr = 1.31121;   const Double_t theo_wr_unc = (0.0320+0.0336)/2.;
  const Double_t theo_wpr= 7.43114;   const Double_t theo_wpr_unc= (0.1585+0.1673)/2.;
  const Double_t theo_wmr= 5.66750;   const Double_t theo_wmr_unc= (0.1092+0.1143)/2.;
  const Double_t theo_wz = 13.0986;   const Double_t theo_wz_unc = (0.2271+0.2434)/2.;
  ...
  textwp.AddText("#bf{W^{+}#rightarrow#mu^{+}#nu}");
  textwp.Draw(); 
  ...
  textwm.AddText("#bf{W^{-}#rightarrow#mu^{-}#nu}");
  textwm.Draw(); 
  ...
  textw.AddText("#bf{W#rightarrow#mu#nu}");
  textw.Draw(); 
  ...
  textz.AddText("#bf{Z#rightarrow#mu^{+}#mu^{-}}");
  textz.Draw(); 
  ...
  textwr.AddText("#bf{W^{+}#rightarrow#mu^{+}#nu / W^{-}#rightarrow#mu^{-}#nu}");
  textwr.Draw(); 

  sprintf(buffer,"%.3f #pm %.3f_{stat} #pm 0.005_{syst}", xsec_wr, xsec_wr_stat);
  //  sprintf(buffer,"%.2f #pm %.2f_{stat} #pm %.2f_{syst}", xsec_wr, xsec_wr_stat, xsec_wr_sys);
  ...
  sprintf(buffer,"%.2f #pm %.2f", theo_wr, theo_wr_unc);
  ...
  textwpr.AddText("#bf{W^{+}#rightarrow#mu^{+}#nu / Z#rightarrow#mu^{+}#mu^{-}}");
  textwpr.Draw(); 
  ...
  textwmr.AddText("#bf{W^{-}#rightarrow#mu^{-}#nu / Z#rightarrow#mu^{+}#mu^{-}}");
  textwmr.Draw(); 
  ...
  textwz.AddText("#bf{W#rightarrow#mu#nu / Z#rightarrow#mu^{+}#mu^{-}}");
  textwz.Draw(); 
  ...
  TPaveText tb5(0.35,0.02,0.98,0.12,"NDC");
  tb5.SetFillStyle(0);
  tb5.SetBorderSize(0);
  tb5.SetTextAlign(12);
  tb5.AddText("ratio (exp./th.) for fiducial measurements");
  tb5.Draw();

  c->SaveAs("xsecFidMuonSummary13TeV.png");
  c->SaveAs("xsecFidMuonSummary13TeV.pdf");
}
