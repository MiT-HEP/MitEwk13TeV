...
void xsecSummary_muon_cteq()
{   
  //TRandom* gRandom = new TRandom3();
  double rand = 0.901493; //gRandom->Gaus(1.0,0.05); 
  //--------------------------------------------------------------------------------------------------------------
  // input parameter
  const Double_t xsec_wp = 12225*rand;   const Double_t xsec_wp_stat = 0;   const Double_t xsec_wp_sys =89*rand;   const Double_t xsec_wp_lumi = 208*rand;
  const Double_t xsec_wm = 9014*rand;    const Double_t xsec_wm_stat = 0;   const Double_t xsec_wm_sys = 69*rand;   const Double_t xsec_wm_lumi = 153*rand;
  const Double_t xsec_w  = 21247*rand;   const Double_t xsec_w_stat  = 0;   const Double_t xsec_w_sys  = 130*rand;   const Double_t xsec_w_lumi  = 361*rand;
  const Double_t xsec_z  = 2012*rand;    const Double_t xsec_z_stat  = 0;    const Double_t xsec_z_sys  = 19*rand;    const Double_t xsec_z_lumi  = 34*rand;
  const Double_t xsec_wr = 1.35661;   const Double_t xsec_wr_stat = 0.0;   const Double_t xsec_wr_sys = 0.006729; 
  const Double_t xsec_wpr= 6.08427;   const Double_t xsec_wpr_stat= 0.0;   const Double_t xsec_wpr_sys= 0.04056; 
  const Double_t xsec_wmr= 4.48204;   const Double_t xsec_wmr_stat= 0.0;   const Double_t xsec_wmr_sys= 0.0301; 
  const Double_t xsec_wz = 10.5747;  const Double_t xsec_wz_stat = 0.0;   const Double_t xsec_wz_sys = 0.0707; 
  ...
  c->SaveAs("xsecSummary13TeV_muon_ct18.png");
  c->SaveAs("xsecSummary13TeV_muon_ct18.pdf");
}
