...
protected:
  ...
  // figure out which of these i can delete (probably all of them actually)
  TRandom1 *fRandom; 
  ...
  //// don't delete most, check carefully
