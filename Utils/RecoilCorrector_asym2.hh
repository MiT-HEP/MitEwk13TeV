...
//                 TGraphErrors *iU1RZDatFit3,  TGraphErrors *iU1RZMCFit3,
...
//   myXdU1_2->setVal(pU1);
//   std::cout <<  "data cdf pdf = "  <<thisCdfDataU1_2->getVal() << std::endl;
//   std::cout <<  "data pdf pdf = "  <<thisPdfDataU1_2->getVal() << std::endl;
//   myXdU2_2->setVal(pU2);
//   std::cout <<  "data cdf pdf = "  <<thisCdfDataU2_2->getVal() << std::endl;
//   std::cout <<  "data pdf pdf = "  <<thisPdfDataU2_2->getVal() << std::endl;
//   myXmU1_2->setVal(pU1);
//   std::cout <<  "data cdf pdf = "  <<thisCdfMCU1_2->getVal() << std::endl;
//   std::cout <<  "data pdf pdf = "  <<thisPdfMCU1_2->getVal() << std::endl;
//   myXmU2_2->setVal(pU2);
//   std::cout <<  "data cdf pdf = "  <<thisCdfMCU2_2->getVal() << std::endl;
//   std::cout <<  "data pdf pdf = "  <<thisPdfMCU2_2->getVal() << std::endl;
//   
//   RooPlot *rooFrame_2 = myXdU1_2->frame(Title(TString("Plot of MC and Data: Double-Gaussians" )));
// //   thisPdfDataU1->plotOn(rooFrame,RooFit::LineColor(kBlue));
//   thisPdfDataU1_2->plotOn(rooFrame_2,RooFit::LineColor(kRed));
// //   thisCdfDataU1_2->plotOn(rooFrame_2,RooFit::LineColor(kGreen));
// //   TCanvas *iC = new TCanvas("C1","C1",800,600); 
//   iC->cd(); rooFrame_2->Draw();
//   iC->SaveAs((varName.str()+"_p.png").c_str());
  
  
//   std::cout << "before " << pU1 << std::endl;
  
  
//   double pU1ValD = triGausInvGraphPDF(pU1,iGenPt,pdfU1MCCdf,pdfU1DatCdf,&rooMCGausAdd,&rooDatGausAdd,iBin,5);
//   double pU1ValD = triGausInvGraphPDF(pU1,iGenPt,pdfU1MCCdf,pdfU1DatCdf,&rooMCGausAdd,&rooDatGausAdd,&rooU1,pDefU1+5);
// std::cout << "doing the inversion 1" << std::endl;
// std::cout << "==============" << std::endl;
// std::cout << "u1, pdefu1 = " << pDefU1 << std::endl;

// test memory leak
//   double pU1ValD = triGausInvGraphPDF(pU1,iGenPt,thisCdfMCU1,thisCdfDataU1,thisPdfMCU1,thisPdfDataU1,iBin,pDefU1);
//   double pU2ValD = triGausInvGraphPDF(pU2,iGenPt,thisCdfMCU2,thisCdfDataU2,thisPdfMCU2,thisPdfDataU2,iBin,0);
...
// // take the TGraphs, make PDF then a CDF out of it
// void RecoilCorrector::MakeCDFs(Int_t nGaus, bool fixedMeans, int fJet){
//   // Load our TGraphs and stuff
//   TGraphErrors* iU1RZDatFit; TGraphErrors* iU1R2ZDatFit; TGraphErrors* iU1R3ZDatFit; // data means
//   TGraphErrors* iU1RZMCFit; TGraphErrors* iU1R2ZMCFit; TGraphErrors* iU1R3ZMCFit; // mc means
//   TGraphErrors* iU1MSZDatFit; TGraphErrors* iU1S1ZDatFit; TGraphErrors* iU1S2ZDatFit; TGraphErrors* iU1S3ZDatFit; // data sigmas
//   TGraphErrors* iU1MSZMCFit; TGraphErrors* iU1S1ZMCFit; TGraphErrors* iU1S2ZMCFit; TGraphErrors* iU1S3ZMCFit; // mc sigmas
//   TGraphErrors* iU1DatFrac2; TGraphErrors* iU1DatFrac3; TGraphErrors* iU1MCFrac2; TGraphErrors* iU1MCFrac3; 
//   
//   iU1RZDatFit = fMT1U1Fit[fJet]; // data mean 1
//   iU1RZMCFit = fM1U1Fit[fJet]; // mc mean 1
//   iU1MSZDatFit = fMT1U1RMSSMFit[fJet]; // data sigma0
//   iU1MSZMCFit = fM1U1RMSSMFit[fJet]; // mc sigma0
//   iU1S1ZDatFit = fMT1U1RMS1Fit [fJet]; // data sigma1
//   iU1S1ZMCFit = fM1U1RMS1Fit [fJet]; // mc sigma1
//   
//   if(nGaus >= 2){
//     iU1S2ZDatFit = fMT1U1RMS2Fit [fJet]; // sigma2 data
//     iU1S2ZMCFit = fM1U1RMS2Fit [fJet]; // sigma2 mc
//     iU1DatFrac2 = fMT1U1Frac2[fJet]; // frac2 data
//     iU1MCFrac2  = fM1U1Frac2[fJet]; // frac2 mc
//     
//     if(fixedMeans == true){ // load the standard means here
//       iU1R2ZDatFit = fMT1U1Fit    [fJet];
//       iU1R2ZMCFit = fM1U1Fit    [fJet];
//     } else { // load the other means
//       iU1R2ZDatFit = fMT1U1Fit2    [fJet];
//       iU1R2ZMCFit = fM1U1Fit2    [fJet];
//     }
//   }
//   if(nGaus == 3){
//     iU1S3ZDatFit = fMT1U1RMS3Fit [fJet];
//     iU1S3ZMCFit = fM1U1RMS3Fit [fJet];
//     iU1DatFrac3 = fMT1U1Frac3[fJet];
//     iU1MCFrac3 = fM1U1Frac3[fJet];
//     
//     if(fixedMeans == true){
//       iU1R3ZDatFit = fMT1U1Fit    [fJet];
//       iU1R3ZMCFit = fM1U1Fit    [fJet];
//     } else { // load the other means
//       iU1R3ZDatFit = fMT1U1Fit3    [fJet];
//       iU1R3ZMCFit = fM1U1Fit3    [fJet];
//     }
//   }
// //   std::cout << "loaded the files? " << std::endl;
//       
//   // All the TGraphs for the Sigmas & stuff are loaded
// 
//   vZPtBins={0,0.5,1.0,1.5,2.0,2.5,3.0,4.0,5.0,6.0,7.5,10,12.5,15,17.5,20,22.5,25,27.5,30,32.5,35,37.5,40,42.5,45,47.5,50,52.5,55,57.5,60,62.5,65,67.5,70,72.5,75,80,85,90,95,100,110,120,130,140,150,160,170,180,190,200,210,220,230,240,250,275,300};//{0,0.5,1.0,1.5,2.0,2.5,3.0,4.0,5.0,6.0,7.5,10,12.5,15,17.5,20,22.5,25,27.5,30,32.5,35,37.5,40,42.5,45,47.5,50,52.5,55,57.5,60,62.5,65,67.5,70,72.5,75,77.5,80,82.5,85,87.5,90,92.5,95,97.5,100};
// //   //{0,2.5,5.0,7.5,10,12.5,15,17.5,20,22.5,25,27.5,30,32.5,35,37.5,40,42.5,45,47.5,50,52.5,55,57.5,60,62.5,65,67.5,70,72.5,75,77.5,80,82.5,85,87.5,90,92.5,95,97.5,100};
// //   prepCdfs(rooWData);
// //   prepCdfs(rooWMC);
//   int nZPtBins = vZPtBins.size();
// 
//   for(int i = 0; i < nZPtBins; ++i){ // loop through all the pT bins
// //   std::cout << "in the loop" << std::endl;
//     double iGenPt = (vZPtBins[i+1]+vZPtBins[i])/2;
//     
//     std::stringstream lSS; lSS << "rooU1_" << i;
//     RooRealVar rooU1(lSS.str().c_str(),"U_{1}",0,-300,100); rooU1.setBins(400);  lSS.str(""); 
//   
//     // Calculate a RooPDF for the Data
//     lSS << "rooDatMeanU1_1_" << i; RooRealVar rooDatMeanU1_1(lSS.str().c_str(),"rooDatMeanU1_1",iU1RZDatFit->Eval(iGenPt));   lSS.str(""); // mean 1
//     lSS << "rooDatMeanU1_2_" << i; RooRealVar rooDatMeanU1_2(lSS.str().c_str(),"rooDatMeanU1_2",0); lSS.str(""); 
//     lSS << "rooDatMeanU1_3_" << i; RooRealVar rooDatMeanU1_3(lSS.str().c_str(),"rooDatMeanU1_3",0); lSS.str(""); 
//     lSS << "rooMCMeanU1_1_" << i; RooRealVar rooMCMeanU1_1(lSS.str().c_str(),"rooMCMeanU1_1",iU1RZMCFit->Eval(iGenPt)); lSS.str(""); 
//     lSS << "rooMCMeanU1_2_" << i; RooRealVar rooMCMeanU1_2(lSS.str().c_str(),"rooMCMeanU1_2",0); lSS.str(""); 
//     lSS << "rooMCMeanU1_3_" << i; RooRealVar rooMCMeanU1_3(lSS.str().c_str(),"rooMCMeanU1_3",0); lSS.str(""); 
// //     std::cout << "loaded some stuff " << std::endl;
//     if(fixedMeans == true){
//       rooDatMeanU1_2 = rooDatMeanU1_1;// ("rooDatMeanU1_2","rooDatMeanU1_2",0); // mean 2
//       rooDatMeanU1_3 = rooDatMeanU1_1;//("rooDatMeanU1_3","rooDatMeanU1_3",0);
//     } else if (fixedMeans == false){
//       if(nGaus >= 2){
//         rooDatMeanU1_2.setVal(iU1R2ZDatFit->Eval(iGenPt));
//         rooMCMeanU1_2.setVal(iU1R2ZMCFit->Eval(iGenPt));
//       }
//       if(nGaus == 3){
//         rooDatMeanU1_3.setVal(iU1R3ZDatFit->Eval(iGenPt));
//         rooMCMeanU1_3.setVal(iU1R3ZMCFit->Eval(iGenPt));
//       } // mean 3
//     }
//     lSS << "rooDatFrac2_" << i; RooRealVar rooDatFrac2(lSS.str().c_str(),"rooDatFrac2",0);   lSS.str(""); 
//     lSS << "rooDatFrac3_" << i; RooRealVar rooDatFrac3(lSS.str().c_str(),"rooDatFrac3",0);   lSS.str(""); 
//     lSS << "rooMCFrac2_" << i; RooRealVar rooMCFrac2(lSS.str().c_str(),"rooMCFrac2",0);   lSS.str(""); 
//     lSS << "rooMCFrac3_" << i; RooRealVar rooMCFrac3(lSS.str().c_str(),"rooMCFrac3",0); lSS.str(""); 
//     lSS << "rooDatSigma1_" << i; RooRealVar rooDatSigma1(lSS.str().c_str(),"rooDatSigma1",iU1S1ZDatFit->Eval(iGenPt));  lSS.str(""); 
//     lSS << "rooDatSigma2_" << i; RooRealVar rooDatSigma2(lSS.str().c_str(),"rooDatSigma2",0);  lSS.str(""); 
//     lSS << "rooDatSigma3_" << i; RooRealVar rooDatSigma3(lSS.str().c_str(),"rooDatSigma3",0); lSS.str(""); 
//     lSS << "rooMCSigma1_" << i; RooRealVar rooMCSigma1(lSS.str().c_str(),"rooMCSigma1",iU1S1ZMCFit->Eval(iGenPt));  lSS.str(""); 
//     lSS << "rooMCSigma2_" << i; RooRealVar rooMCSigma2(lSS.str().c_str(),"rooMCSigma2",0);  lSS.str(""); 
//     lSS << "rooMCSigma3_" << i; RooRealVar rooMCSigma3(lSS.str().c_str(),"rooMCSigma3",0); lSS.str(""); 
//     
//     if(nGaus==2){
//       rooDatSigma1.setVal(iU1S1ZDatFit->Eval(iGenPt));
//       rooDatSigma2.setVal(iU1S2ZDatFit->Eval(iGenPt));
//       rooDatSigma3.setVal(0);
//       rooMCSigma1.setVal(iU1S1ZMCFit->Eval(iGenPt));
//       rooMCSigma2.setVal(iU1S2ZMCFit->Eval(iGenPt));
//       rooMCSigma3.setVal(0);
//       rooDatFrac2.setVal(iU1DatFrac2->Eval(iGenPt));
//       rooMCFrac2.setVal(iU1MCFrac2->Eval(iGenPt));
//       rooDatFrac3.setVal(0);
//       rooMCFrac3.setVal(0);
//     }
//     if(nGaus==3){
//       rooDatSigma1.setVal(iU1S1ZDatFit->Eval(iGenPt));
//       rooDatSigma2.setVal(iU1S2ZDatFit->Eval(iGenPt));
//       rooDatSigma3.setVal(iU1S3ZDatFit->Eval(iGenPt));
//       rooMCSigma1.setVal(iU1S1ZMCFit->Eval(iGenPt));
//       rooMCSigma2.setVal(iU1S2ZMCFit->Eval(iGenPt));
//       rooMCSigma3.setVal(iU1S3ZMCFit->Eval(iGenPt));
//       rooDatFrac2.setVal(iU1DatFrac2->Eval(iGenPt));
//       rooMCFrac2.setVal(iU1MCFrac2->Eval(iGenPt));
//       rooDatFrac3.setVal(iU1DatFrac3->Eval(iGenPt));
//       rooMCFrac3.setVal(iU1MCFrac3->Eval(iGenPt));
// //       std::cout << "done ng3" << std::endl;
//     }
//   
//   
//   
//   // Make individual Gaussians
//   lSS << "rooDatGaus1_" << i; RooGaussian   rooDatGaus1(lSS.str().c_str(),"rooGaus1",rooU1,rooDatMeanU1_1,rooDatSigma1); lSS.str(""); 
//   lSS << "rooDatGaus2_" << i; RooGaussian   rooDatGaus2(lSS.str().c_str(),"rooGaus2",rooU1,rooDatMeanU1_2,rooDatSigma2); lSS.str(""); 
//   lSS << "rooDatGaus3_" << i; RooGaussian   rooDatGaus3(lSS.str().c_str(),"rooGaus3",rooU1,rooDatMeanU1_3,rooDatSigma3); lSS.str(""); 
//   lSS << "rooDatGausAdd_" << i; // name each one individually
//   RooAddPdf rooDatGausAdd(lSS.str().c_str(),lSS.str().c_str() ,RooArgList(rooDatGaus2,rooDatGaus3,rooDatGaus1),RooArgList(rooDatFrac2,rooDatFrac3));  lSS.str(""); 
//   
//   std::cout << "rooDatFrac2 " << rooDatFrac2.getVal() << std::endl;
//   std::cout << "rooDatFrac3 " << rooDatFrac3.getVal() << std::endl;
// //   std::cout << "rooDatSigma1 " << rooDatSigma1.getVal() << std::endl;
// //   std::cout << "rooDatSigma2 " << rooDatSigma2.getVal() << std::endl;
// //   std::cout << "rooDatSigma3 " << rooDatSigma3.getVal() << std::endl;
// //   std::cout << "rooDatMean1 " << rooDatMeanU1_1.getVal() << std::endl;
// //   std::cout << "rooDatMean2 " << rooDatMeanU1_2.getVal() << std::endl;
// //   std::cout << "rooDatMean3 " << rooDatMeanU1_2.getVal() << std::endl;
//   std::cout << "iGen Pt  " << iGenPt << std::endl;
//   
// 
//   //  Make individual Gaussians
//   lSS << "rooMCGaus1_" << i; RooGaussian   rooMCGaus1(lSS.str().c_str(),"rooMCGaus1",rooU1,rooMCMeanU1_1,rooMCSigma1); lSS.str(""); 
//   lSS << "rooMCGaus2_" << i; RooGaussian   rooMCGaus2(lSS.str().c_str(),"rooMCGaus2",rooU1,rooMCMeanU1_2,rooMCSigma2); lSS.str(""); 
//   lSS << "rooMCGaus3_" << i; RooGaussian   rooMCGaus3(lSS.str().c_str(),"rooMCGaus3",rooU1,rooMCMeanU1_3,rooMCSigma3); lSS.str(""); 
//   lSS << "rooMCGausAdd_" << i;
//   RooAddPdf rooMCGausAdd(lSS.str().c_str() ,lSS.str().c_str(),RooArgList(rooMCGaus2,rooMCGaus3,rooMCGaus1),RooArgList(rooMCFrac2, rooMCFrac3));  lSS.str(""); 
//   
//   std::cout << "rooMCFrac2 " << rooMCFrac2.getVal() << std::endl;
//   std::cout << "rooMCFrac3 " << rooMCFrac3.getVal() << std::endl;
// //   std::cout << "rooMCSigma1 " << rooMCSigma1.getVal() << std::endl;
// //   std::cout << "rooMCSigma2 " << rooMCSigma2.getVal() << std::endl;
// //   std::cout << "rooMCSigma3 " << rooMCSigma3.getVal() << std::endl;
// //   std::cout << "rooMCMean1 " << rooMCMeanU1_1.getVal() << std::endl;
// //   std::cout << "rooMCMean2 " << rooMCMeanU1_2.getVal() << std::endl;
// //   std::cout << "rooMCMean3 " << rooMCMeanU1_3.getVal() << std::endl;
//   
//   // Create CDFs
//   RooAbsReal *pdfU1DatCdf = rooDatGausAdd.createCdf(rooU1);
//   RooAbsReal *pdfU1MCCdf = rooMCGausAdd.createCdf(rooU1);
// 
//   rooWksDataU1.import(rooDatGausAdd,RooFit::Silence());
//   rooWksMCU1.import(rooMCGausAdd,RooFit::Silence());
//   rooWksDataU1.import(*pdfU1DatCdf,RooFit::Silence());
//   rooWksMCU1.import(*pdfU1MCCdf,RooFit::Silence());
//   
//  
// /*
// //   Print some plots just to check there's nothing super crazy happening when  
// //   adding gaussians
//   std::cout << "PLOTTING IN CREATE CDFS" << std::endl;
//   RooPlot *rooFrame = rooU1.frame(Title(TString("Plot of MC and Data: Double-Gaussians" )));
//   rooMCGausAdd.plotOn(rooFrame,RooFit::LineColor(kBlue));
//   rooMCGausAdd.plotOn(rooFrame,RooFit::Components(rooMCGaus1),RooFit::LineStyle(kDashed),RooFit::LineColor(kRed));
//   rooMCGausAdd.plotOn(rooFrame,RooFit::Components(rooMCGaus2),RooFit::LineStyle(kDashed),RooFit::LineColor(kCyan+2));
//   rooMCGausAdd.plotOn(rooFrame,RooFit::Components(rooMCGaus3),RooFit::LineStyle(kDashed),RooFit::LineColor(kGreen+2));
// //   rooMCGausAdd.plotOn(rooFrame,RooFit::LineColor(kRed));
// //   rooDatGaus2.pldotOn(rooFrame,RooFit::LineColor(kViolet));
// //   rooCdfsData[i]->plotOn(rooFrame,RooFit::LineColor(kBlue));
// //   rooCdfsMC[i]->plotOn(rooFrame,RooFit::LineColor(kRed));
// //   pdfU1DatCdf->plotOn(rooFrame,RooFit::LineColor(kGreen));
// //   pdfU1MCCdf->plotOn(rooFrame,RooFit::LineColor(kViolet));
// //     
// //   TCanvas *iC = new TCanvas("C1","C1",800,600); 
//   iC->cd(); rooFrame->Draw();
//   stringstream pSS1; pSS1 << "checkFitsMCGaussU1_" << i << ".png";
//   iC->SaveAs(pSS1.str().c_str());
//    std::cout << "DONE PLOTTING IN CREATE CDFS" << std::endl;*/
...
// }
// /*
// void RecoilCorrector::MakeCDFsU2(Int_t nGaus, bool fixedMeans, int fJet){
//   Load our TGraphs and stuff
//   TGraphErrors* iU2RZDatFit; TGraphErrors* iU2R2ZDatFit; TGraphErrors* iU2R3ZDatFit; // data means
//   TGraphErrors* iU2RZMCFit; TGraphErrors* iU2R2ZMCFit; TGraphErrors* iU2R3ZMCFit; // mc means
//   TGraphErrors* iU2MSZDatFit; TGraphErrors* iU2S1ZDatFit; TGraphErrors* iU2S2ZDatFit; TGraphErrors* iU2S3ZDatFit; // data sigmas
//   TGraphErrors* iU2MSZMCFit; TGraphErrors* iU2S1ZMCFit; TGraphErrors* iU2S2ZMCFit; TGraphErrors* iU2S3ZMCFit; // mc sigmas
//   TGraphErrors* iU2DatFrac2; TGraphErrors* iU2DatFrac3; TGraphErrors* iU2MCFrac2; TGraphErrors* iU2MCFrac3; 
//   
//   iU2RZDatFit = fMT1U2Fit[fJet]; // data mean 1
//   iU2RZMCFit = fM1U2Fit[fJet]; // mc mean 1
//   iU2MSZDatFit = fMT1U2RMSSMFit[fJet]; // data sigma0
//   iU2MSZMCFit = fM1U2RMSSMFit[fJet]; // mc sigma0
//   iU2S1ZDatFit = fMT1U2RMS1Fit [fJet]; // data sigma1
//   iU2S1ZMCFit = fM1U2RMS1Fit [fJet]; // mc sigma1
//   iU2RZDatFit->Print();
//   
//   if(nGaus >= 2){
//     iU2S2ZDatFit = fMT1U2RMS2Fit [fJet]; // sigma2 data
//     iU2S2ZMCFit = fM1U2RMS2Fit [fJet]; // sigma2 mc
//     iU2DatFrac2 = fMT1U2Frac2[fJet]; // frac2 data
//     iU2MCFrac2  = fM1U2Frac2[fJet]; // frac2 mc
//     
//     if(fixedMeans == true){ // load the standard means here
//       iU2R2ZDatFit = fMT1U2Fit    [fJet];
//       iU2R2ZMCFit = fM1U2Fit    [fJet];
//     } /*else { // load the other means
//       iU2R2ZDatFit = fMT1U2Fit2    [fJet];
//       iU2R2ZMCFit = fM1U2Fit2    [fJet];
//     }*/
//   }
//   if(nGaus == 3){
//     iU2S3ZDatFit = fMT1U2RMS3Fit [fJet];
//     iU2S3ZMCFit = fM1U2RMS3Fit [fJet];
//     iU2DatFrac3 = fMT1U2Frac3[fJet];
//     iU2MCFrac3 = fM1U2Frac3[fJet];
//     
//     if(fixedMeans == true){
//       iU2R3ZDatFit = fMT1U2Fit    [fJet];
//       iU2R3ZMCFit = fM1U2Fit    [fJet];
//     } /*else { // load the other means
//       iU2R3ZDatFit = fMT1U2Fit3    [fJet];
//       iU2R3ZMCFit = fM1U2Fit3    [fJet];
//     }*/
//   }
//   iU2DatFrac2->Print();
//   std::cout << "loaded the files? " << std::endl;
...
// 
//  
//   vZPtBins = {0,1,2.5,5.0,7.5,10,12.5,15,17.5,20,22.5,25,27.5,30,32.5,35,37.5,40,42.5,45,47.5,50,52.5,55,57.5,60,62.5,65,67.5,70,72.5,75,77.5,80,82.5,85,87.5,90,92.5,95,97.5,100};
//   int nZPtBins = vZPtBins.size();
//    std::cout << nZPtBins << std::endl;
//   std::cout << "what" << std::endl;
//   for(int i = 0; i < nZPtBins; ++i){ // loop through all the pT bins
//     std::cout << "in the loop" << std::endl;
//     double iGenPt = (vZPtBins[i+1]+vZPtBins[i])/2;
//     std::cout << "jhi " << std::endl;
//     std::stringstream lSS; lSS << "rooU1_" << i;
//     RooRealVar rooU1(lSS.str().c_str(),"U_{1}",0,-300,100); rooU1.setBins(400);  lSS.str(""); 
//     std::cout << "made U2" << std::endl;
//     Calculate a RooPDF for the Data
//     lSS << "rooDatMeanU2_1_" << i; RooRealVar rooDatMeanU2_1(lSS.str().c_str(),"rooDatMeanU2_1",iU2RZDatFit->Eval(iGenPt));   lSS.str(""); // mean 1
//     lSS << "rooDatMeanU2_2_" << i; RooRealVar rooDatMeanU2_2(lSS.str().c_str(),"rooDatMeanU2_2",iU2RZDatFit->Eval(iGenPt)); lSS.str(""); 
//     lSS << "rooDatMeanU2_3_" << i; RooRealVar rooDatMeanU2_3(lSS.str().c_str(),"rooDatMeanU2_3",iU2RZDatFit->Eval(iGenPt)); lSS.str(""); 
//     std::cout << "made a few more..." << std::endl;
//     lSS << "rooMCMeanU2_1_" << i; RooRealVar rooMCMeanU2_1(lSS.str().c_str(),"rooMCMeanU2_1",iU2RZMCFit->Eval(iGenPt)); lSS.str(""); 
//     lSS << "rooMCMeanU2_2_" << i; RooRealVar rooMCMeanU2_2(lSS.str().c_str(),"rooMCMeanU2_2",iU2RZMCFit->Eval(iGenPt)); lSS.str(""); 
//     lSS << "rooMCMeanU2_3_" << i; RooRealVar rooMCMeanU2_3(lSS.str().c_str(),"rooMCMeanU2_3",iU2RZMCFit->Eval(iGenPt)); lSS.str(""); 
//     std::cout << "hey" << std::endl;
//     std::cout << "loaded some stuff " << std::endl;
//     if(fixedMeans == true){
//       std::cout << "blahhhhh " << std::endl;
//       rooDatMeanU2_2.setVal(rooDatMeanU2_1.getVal());
//       rooDatMeanU2_3.setVal(rooDatMeanU2_1.getVal()); 
//       rooMCMeanU2_2.setVal(rooMCMeanU2_1.getVal());// ("rooDatMeanU2_2","rooDatMeanU2_2",0); // mean 2
//       rooMCMeanU2_3.setVal(rooMCMeanU2_1.getVal());//("rooDatMeanU2_3","rooDatMeanU2_3",0);
//     } 
//     lSS << "rooDatFrac2_" << i; RooRealVar rooDatFrac2(lSS.str().c_str(),"rooDatFrac2",0);   lSS.str(""); 
//     lSS << "rooDatFrac3_" << i; RooRealVar rooDatFrac3(lSS.str().c_str(),"rooDatFrac3",0);   lSS.str(""); 
//     lSS << "rooMCFrac2_" << i; RooRealVar rooMCFrac2(lSS.str().c_str(),"rooMCFrac2",0);   lSS.str(""); 
//     lSS << "rooMCFrac3_" << i; RooRealVar rooMCFrac3(lSS.str().c_str(),"rooMCFrac3",0); lSS.str(""); 
//     lSS << "rooDatSigma1_" << i; RooRealVar rooDatSigma1(lSS.str().c_str(),"rooDatSigma1",iU2S1ZDatFit->Eval(iGenPt));  lSS.str(""); 
//     lSS << "rooDatSigma2_" << i; RooRealVar rooDatSigma2(lSS.str().c_str(),"rooDatSigma2",0);  lSS.str(""); 
//     lSS << "rooDatSigma3_" << i; RooRealVar rooDatSigma3(lSS.str().c_str(),"rooDatSigma3",0); lSS.str(""); 
//     lSS << "rooMCSigma1_" << i; RooRealVar rooMCSigma1(lSS.str().c_str(),"rooMCSigma1",iU2S1ZMCFit->Eval(iGenPt));  lSS.str(""); 
//     lSS << "rooMCSigma2_" << i; RooRealVar rooMCSigma2(lSS.str().c_str(),"rooMCSigma2",0);  lSS.str(""); 
//     lSS << "rooMCSigma3_" << i; RooRealVar rooMCSigma3(lSS.str().c_str(),"rooMCSigma3",0); lSS.str(""); 
//     std::cout << "heyo" << std::endl;
// 
//     if(nGaus==3){
//       rooDatSigma1.setVal(iU2S1ZDatFit->Eval(iGenPt));
//       rooDatSigma2.setVal(iU2S2ZDatFit->Eval(iGenPt));
//       rooDatSigma3.setVal(iU2S3ZDatFit->Eval(iGenPt));
//       rooMCSigma1.setVal(iU2S1ZMCFit->Eval(iGenPt));
//       rooMCSigma2.setVal(iU2S2ZMCFit->Eval(iGenPt));
//       rooMCSigma3.setVal(iU2S3ZMCFit->Eval(iGenPt));
//       rooDatFrac2.setVal(iU2DatFrac2->Eval(iGenPt));
//       rooMCFrac2.setVal(iU2MCFrac2->Eval(iGenPt));
//       rooDatFrac3.setVal(iU2DatFrac3->Eval(iGenPt));
//       rooMCFrac3.setVal(iU2MCFrac3->Eval(iGenPt));
//       std::cout << "done ng3" << std::endl;
//     }
//   
...
//   
//   Make individual Gaussians
//   lSS << "rooDatGaus1_" << i; RooGaussian   rooDatGaus1(lSS.str().c_str(),"rooGaus1",rooU1,rooDatMeanU2_1,rooDatSigma1); lSS.str(""); 
//   lSS << "rooDatGaus2_" << i; RooGaussian   rooDatGaus2(lSS.str().c_str(),"rooGaus2",rooU1,rooDatMeanU2_2,rooDatSigma2); lSS.str(""); 
//   lSS << "rooDatGaus3_" << i; RooGaussian   rooDatGaus3(lSS.str().c_str(),"rooGaus3",rooU1,rooDatMeanU2_3,rooDatSigma3); lSS.str(""); 
//   lSS << "rooDatGausAdd_" << i; // name each one individually
//   RooAddPdf rooDatGausAdd(lSS.str().c_str(),lSS.str().c_str() ,RooArgList(rooDatGaus2,rooDatGaus3,rooDatGaus1),RooArgList(rooDatFrac2,rooDatFrac3));  lSS.str(""); 
//   
//   std::cout << "rooDatFrac2 " << rooDatFrac2.getVal() << std::endl;
...
//   std::cout << "rooDatSigma2 " << rooDatSigma2.getVal() << std::endl;
//   std::cout << "rooDatSigma3 " << rooDatSigma3.getVal() << std::endl;
//   std::cout << "rooDatMean1 " << rooDatMeanU2_1.getVal() << std::endl;
//   std::cout << "rooDatMean2 " << rooDatMeanU2_2.getVal() << std::endl;
//   std::cout << "rooDatMean3 " << rooDatMeanU2_2.getVal() << std::endl;
//   std::cout << "iGen Pt  " << iGenPt << std::endl;
// 
//    Make individual Gaussians
//   lSS << "rooMCGaus1_" << i; RooGaussian   rooMCGaus1(lSS.str().c_str(),"rooMCGaus1",rooU1,rooMCMeanU2_1,rooMCSigma1); lSS.str(""); 
//   lSS << "rooMCGaus2_" << i; RooGaussian   rooMCGaus2(lSS.str().c_str(),"rooMCGaus2",rooU1,rooMCMeanU2_2,rooMCSigma2); lSS.str(""); 
//   lSS << "rooMCGaus3_" << i; RooGaussian   rooMCGaus3(lSS.str().c_str(),"rooMCGaus3",rooU1,rooMCMeanU2_3,rooMCSigma3); lSS.str(""); 
//   lSS << "rooMCGausAdd_" << i;
//   RooAddPdf rooMCGausAdd(lSS.str().c_str() ,lSS.str().c_str(),RooArgList(rooMCGaus2,rooMCGaus3,rooMCGaus1),RooArgList(rooMCFrac2, rooMCFrac3));  lSS.str(""); 
//   
//   std::cout << "rooMCFrac2 " << rooMCFrac2.getVal() << std::endl;
...
//   std::cout << "rooMCSigma2 " << rooMCSigma2.getVal() << std::endl;
//   std::cout << "rooMCSigma3 " << rooMCSigma3.getVal() << std::endl;
//   std::cout << "rooMCMean1 " << rooMCMeanU2_1.getVal() << std::endl;
//   std::cout << "rooMCMean2 " << rooMCMeanU2_2.getVal() << std::endl;
//   std::cout << "rooMCMean3 " << rooMCMeanU2_3.getVal() << std::endl;
//   
//   Create CDFs
//   RooAbsReal *pdfU2DatCdf = rooDatGausAdd.createCdf(rooU1);
//   RooAbsReal *pdfU2MCCdf = rooMCGausAdd.createCdf(rooU1);
// 
//   std::cout << "hellp" << std::endl;
//   rooWksDataU2.import(rooDatGausAdd);
//   rooWksMCU2.import(rooMCGausAdd);
//   rooWksDataU2.import(*pdfU2DatCdf);
//   rooWksMCU2.import(*pdfU2MCCdf);
//   
//   
//     std::cout << "PLOTTING IN CREATE CDFS" << std::endl;
//   RooPlot *rooFrame = rooU1.frame(Title(TString("Plot of MC and Data: Double-Gaussians" )));
...
// //   TCanvas *iC = new TCanvas("C1","C1",800,600); 
//   iC->cd(); rooFrame->Draw();
//   stringstream pSS1; pSS1 << "checkFitsMCGaussU2_" << i << ".png";
//   iC->SaveAs(pSS1.str().c_str());
//    std::cout << "DONE PLOTTING IN CREATE CDFS" << std::endl;
//   
//   std::cout << "last i = " << i << std::endl;
